...
class Village {
	...
	public $resarray = [];
	public $unitarray, $unitarray2, $techarray, $unitall, $researching, $abarray = [];
	private $infoarray = [];
	private $production = [];
	private $oasisowned, $ocounter = [];
	public $enforcetome, $enforcetoyou, $enforceoasis = [];
	public $allcrop, $currentcel, $loyalty;
	...
	private function processProduction() {
		...
		$database->updateResourceandStarvData($this->wid, $nwood, $nclay, $niron, $ncrop, $this->production['crop'], 1);
        $this->LoadTown(true);
	}
