...
class Technology {
	...
	public function meetRRequirement($tech) {
		...
		switch($tech) {
			case 2:
			case 62:
			case 82: return $building->getTypeLevel(22) >= 1 && $building->getTypeLevel(13) >= 1;
			
			case 3:
			case 52: return $building->getTypeLevel(22) >= 5 && $building->getTypeLevel(12) >= 1;
			...
			case 64: 
			case 72: 
			case 84: return$building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 1;

			case 5:
			case 25:
			case 55: return $building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 5;
			...
			case 65: 
			case 75:
			case 85: return $building->getTypeLevel(22) >= 5 && $building->getTypeLevel(20) >= 3;

			case 73: return $building->getTypeLevel(22) >= 3 && $building->getTypeLevel(13) >= 1;
			case 74: return $building->getTypeLevel(22) >= 5 && $building->getTypeLevel(12) >= 5;
