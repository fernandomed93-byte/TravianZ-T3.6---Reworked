...
define('STONEWALL_DESC', 'Provides a strong defense bonus for your troops. Difficult to destroy.<br>Tribe-specific: Egyptians only');
define('MAKESHIFTWALL', 'Makeshift Wall');
define('MAKESHIFTWALL_DESC', 'Provides a weak defense bonus for your troops. Easy to destroy.<br>Tribe-specific: Huns only');
...
define('DEFENSIVEWALL_DESC', 'Provides a strong defense bonus for your troops.<br>Tribe-specific: Spartans only');
...
define('BARRICADE_DESC', 'Provides a moderate defense bonus for your troops.<br>Tribe-specific: Vikings only');
