...
define('TRIBE6', 'Huns');
define('TRIBE7', 'Egyptians');
define('TRIBE8', 'Spartans');
define('TRIBE9', 'Vikings');
...
define('GOLD', 'Gold');
define('GOLDQST', '... Gold');
define('GOLD_IMG', '<img src=\"/gpack/travian_default/img/x.gif\" class=\"gold\" alt=\"'.GOLDQST.'\" title=\"'.GOLD.'\">');
...
//HUN UNITS (Tribe 6)
define('U51', 'Mercenary');
define('U52', 'Bowman');
define('U53', 'Spotter');
define('U54', 'Steppe Rider');
define('U55', 'Marksman');
define('U56', 'Marauder');
define('U57', 'Ram');
define('U58', 'Catapult');
...
define('U61', 'Slave Militia');
define('U62', 'Ash Warden');
define('U63', 'Khopesh Warrior');
define('U64', 'Sopdu Explorer');
define('U65', 'Anhur Guard');
define('U66', 'Resheph Chariot');
define('U67', 'Ram');
define('U68', 'Stone Catapult');
define('U69', 'Nomarch');
define('U70', 'Settler');
...
define('U81', 'Thrall');
define('U82', 'Shield Maiden');
define('U83', 'Berserker');
define('U84', "Heimdall's Eye");
define('U85', 'Huskarl Rider');
define('U86', "Valkyrie's Blessing");
define('U87', 'Ram');
define('U88', 'Catapult');
define('U89', 'Jarl');
define('U90', 'Settler');
...
//============ UNIT DESCRIPTIONS ==============//
//======================================================//
define('U1DESC', 'The Legionnaire is the simple and all-purpose infantry of the Roman Empire. With his well-rounded training, he is good at both defence and attack. However, the Legionnaire will never reach the levels of the more specialized troops.');
define('U2DESC', 'The Praetorians are the emperor\'s guard and they defend him with their life. Because their training is specialized for defence, they are very weak attackers.');
define('U3DESC', 'The Imperian is the ultimate attacker of the Roman Empire. He is quick, strong, and the nightmare of all defenders. However, his training is expensive and time-intensive.');
define('U4DESC', 'The Equites Legati are the roman reconnaissance troops. They are pretty fast and can spy on enemy villages in order to see resources and troops.<br /><br />If there are no Scouts, Equites Legati or Pathfinders in the scouted village, the scouting remains unnoticed.');
define('U5DESC', 'The Equites Imperatoris are the standard cavalry of the roman army and are very well armed. They are not the fastest troops, but are a horror for unprepared enemies. You should, however, always keep in mind that catering for horse and rider isn\'t cheap.');
define('U6DESC', 'The Equites Caesaris are the heavy cavalry of Rome. They are very well armoured and deal great amounts of damage, but all that armour and weaponry comes with a price. They are slow, carry less resources and feeding them is expensive.');
define('U7DESC', 'The Battering Ram is a heavy support weapon for your infantry and cavalry. Its task is to destroy the enemy walls and therefore increase your troops\' chances of overcoming the enemy\'s fortifications.');
define('U8DESC', 'The Catapult is an excellent long-distance weapon; it is used to destroy the fields and buildings of enemy villages. However, without escorting troops it is almost defenceless so don\'t forget to send some of your troops with it. <br /><br />Having a high level rally point makes your catapults more accurate and gives you the option to target additional enemy buildings. With a level 10 rally point each building except for the cranny, stonemason\'s lodge and trapper can be targeted. <br />HINT: Fire catapults CAN hit the cranny, trappers or stonemason\'s lodge when they target randomly.');
define('U9DESC', 'The Senator is the tribe\'s chosen leader. He\'s a good speaker and knows how to convince others. He is able to persuade other villages to fight with the empire. <br /><br />Every time the Senator speaks to the inhabitants of a village the enemy\'s loyalty value decreases until the village is yours.');
define('U10DESC', 'Settlers are brave and daring citizens who move out of the village after a long training session to found a new village in your honour. <br /><br />As the journey and the founding of the new village are very difficult, three settlers are bound to stick together. They need a basis of 750 units per resource.');
define('U11DESC', 'Clubswingers are the cheapest unit in Travian. They are quickly trained and have medium attack capabilities but their armour isn\'t the best. Clubswingers are almost defenceless against cavalry and will be ridden down with ease.');
define('U12DESC', 'In the Teuton army the Spearman\'s task is defence. He is especially good against cavalry thanks to his weapons length.<br /><br />However, don\'t use him as an attacking unit because his offensive capabilities are very low.');
define('U13DESC', 'This is the Teuton\'s strongest infantry unit. He is strong at both offence and defence but he is slower and more expensive than other units.');
define('U14DESC', 'The Scout moves far ahead of the Teuton troops in order to get an impression of the enemy\'s strength and his villages. He moves on foot, which makes him slower than his Roman or Gaul counterparts. He scouts the enemy units, resources and fortifications. <br /><br />If there are no enemy Scouts, Pathfinders or Equites Legati in the scouted village then the scouting remains unnoticed.');
define('U15DESC', 'As they are equipped with heavy armour Paladins are a great defensive unit. Infantry will find it especially hard to get through his shield. <br /><br />Unfortunately their attacking capabilities are rather low and their speed, compared to other cavalry units, is below the average. Their training takes very long and is rather expensive.');
define('U16DESC', 'The Teutonic Knight is a formidable warrior and brings fear and despair over his foes. In defence he stands out against enemy cavalry. However, the cost of training and feeding him is extraordinary.');
define('U17DESC', 'The Ram is a heavy support weapon for your infantry and cavalry. Its task is to destroy the enemy walls and therefore increase your troops\' chances of overcoming the enemy\'s fortifications.');
define('U18DESC', 'The Catapult is an excellent long-distance weapon; it is used to destroy the fields and buildings of enemy villages. However, without escorting troops it is almost defenceless so don\'t forget to send some of your troops with it. <br /><br />Having a high level rally point makes your catapults more accurate and gives you the option to target additional enemy buildings. With a level 10 rally point each building except for the cranny, stonemason\'s lodge and trapper can be targeted. <br />HINT: Catapults CAN hit the cranny, trappers or stonemason\'s lodges when they target randomly.');
define('U19DESC', 'Out of their midst the Teutons choose their Chief. To be chosen, bravery and strategy aren\'t enough; you also have to be a formidable speaker as it is the Chief\'s primary objective to convince the population of foreign villages to join the Chief\'s tribe. <br /><br />The more often the Chief speaks to the population of a village the more the loyalty of the village sinks until it finally joins the chief\'s tribe.');
define('U20DESC', 'Settlers are brave and daring citizens who move out of the village after a long training session to found a new village in your honour. <br /><br />As the journey and the founding of the new village are very difficult, three settlers are bound to stick together. They need a basis of 750 units per resource.');
define('U21DESC', 'As they are infantry, the Phalanx is cheap and fast to produce. <br /><br />Though their attack power is low, in defence they are quite strong against both infantry and cavalry.');
define('U22DESC', 'The Swordsmen are more expensive than the Phalanx, but they are an attacking unit.<br /><br />Defensively they are quite weak, especially against cavalry.');
define('U23DESC', 'The Pathfinder is the Gaul\'s reconnaissance unit. They are very fast and they can carefully advance on the enemy units, resources or buildings to spy on them.<br /><br />If there aren\'t any Scouts, Equites Legati or Pathfinders in the scouted village, the scouting remains unnoticed.');
define('U24DESC', 'Theutates Thunders are very fast and powerful cavalry units. They can carry a large amount of resources which makes them excellent raiders too.<br /><br />In defence their abilities are average at best.');
define('U25DESC', 'This medium cavalry unit is brilliant at defence. The main purpose of the Druidrider is to defend against enemy infantry. Its costs and supply are relatively expensive.');
define('U26DESC', 'The Haeduans are the Gaul\'s ultimate weapon for attacking and defending against cavalry. Few can match them in these points.<br /><br />However, their training and equipment is also very expensive. They eat 3 units of crop per hour so you should think very carefully if they will be worth it.');
define('U27DESC', 'The Ram is a heavy support weapon for your infantry and cavalry. Its task is to destroy the enemy walls and therefore increase your troops\' chances of overcoming the enemy\'s fortifications.');
define('U28DESC', 'The Trebuchet is an excellent long-distance weapon; it is used to destroy the fields and buildings of enemy villages. However, without escorting troops it is almost defenceless so don\'t forget to send some of your troops with it.<br /><br />Having a high level rally point makes your catapults more accurate and gives you the option to target additional enemy buildings. With a level 10 rally point each building except for the cranny, stonemason\'s lodges and trapper can be targeted.<br />HINT: The Trebuchet CAN hit the cranny, trappers or stonemason\'s lodges when it targets randomly.');
define('U29DESC', 'Each tribe has an ancient and experienced fighter whose presence and speeches are able to convince the population of enemy villages to join his tribe.<br /><br />The more often the Chieftain speaks in front of the walls of an enemy village the more its loyalty sinks until it joins the Chieftain\'s tribe.');
define('U30DESC', 'Settlers are brave and daring citizens who move out of the village after a long training session to found a new village in your honour.<br /><br />As the journey and the founding of the new village are very difficult, three settlers are bound to stick together. They need a basis of 750 units per resource.');
define('U31DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Rat will give just 1 experience point.');
define('U32DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Spider will give just 1 experience point.');
define('U33DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Snake will give just 1 experience point.');
define('U34DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Bat will give just 1 experience point.');
define('U35DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Wild Boar will give just 2 experience point.');
define('U36DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Wolf will give just 2 experience point.');
define('U37DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Bear will give just 3 experience point.');
define('U38DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Crocodile will give just 3 experience point.');
define('U39DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Tiger will give just 3 experience point.');
define('U40DESC', 'The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Elephant will give just 5 experience point.');
define('U41DESC', 'Their long and pointed pikes are used as the main line of defence in any battle. The Natarian Pikemen are bold and daring warriors who use their dexterity to quickly down enemy horsemen and finish them off.');
define('U42DESC', 'The thorn-like extensions on their helmets, bracers and shoulder-parts of their armour give the Thorned Warriors their name. The men who fight for the Natars as Thorned Warriors are persistent and well trained, offering a bloody battle to anyone who is foolish enough to attack them.');
define('U43DESC', 'Adored by their people and feared by their enemies, a Guardsman fights without a mount but is nevertheless one of the most valuable soldiers in the Natarian army, thanks to his versatility. They are deemed as well trained fighters, leaving their enemies with almost no chances to win. Due to their heavy armour, they can be used as strong and reliable defence troops too.');
define('U44DESC', 'Birds of Prey are the Natars\' aerial reconnaissance. These trained falcons and hawks patrol the skies, spying on enemy villages to gather information about resources and troop movements. They cannot be detected by conventional scouts and are an invaluable asset for any commander.');
define('U45DESC', 'It smells only of death and decay when the Axeriders saddle up and prepare to go to war. As skillfully as a farmer uses his scythe to reap, an Axerider swings his mighty blade. A single blow is normally sufficient to behead an opponent and make the bystanders cry out in anguish.');
define('U46DESC', 'Only the most skilful and strongest warriors of the Natars survive the training to become a Natarian Knight. Seeing them fight fills one with awe and shows what true warfare is. They wield their blades as if they were one with their arms and hands and use their shields seemingly as a natural extension of their bodies. Even the horses they ride are specially bred and trained - no normal horse would be able to wear the armour the knights\' horses wear, let alone the knight himself, and still be able to go to war. Whispers of their glory have even reached the most distant kingdoms, spreading fear and horror.');
define('U47DESC', 'No other tribe but the Natars knows how to use these impressive creatures for their purposes. Neither a wall nor a palisade can withstand the War elephant\'s attacks. A walking killing machine, trampling down anything that tries to oppose it or tries to come its way.');
define('U48DESC', 'Even as engineers, the Natars were very successful. They created machinery of war long before anyone else and have since then perfected it in every way. The Ballista, a huge crossbow-like weapon, fires its projectiles with such a force that no wall or shield can deflect them. When the engineers dismantle it to move it to the next battlefield, there is usually nothing but ruins left where the projectiles hit.');
define('U49DESC', 'A mixture of pure fear, admiration and awe moves the villagers when the Natarian Emperor speaks to them. This commanding and well outfitted figure is fully aware of his effect on others and knows how to subjugate an entire village with a single harangue.');
define('U50DESC', 'Daring journeymen and master builders, driven by zest for action and knowing every little secret about cultivating land, building Palaces and fortifying villages, the Natarian Settlers go out in parties of three to claim land in the name of their Natarian lords.');
define('U51DESC', 'The Mercenary is the basic infantry of the Huns. A hired warrior from conquered lands, he fights for gold rather than loyalty. While not exceptionally skilled, his low cost and fast training time make him a solid choice for early raids and defensive support.');
define('U52DESC', 'The Bowman serves as the Hun ranged infantry. Armed with a composite bow, he can strike enemies from a distance before they reach melee range. His attack power is decent for an infantry unit, though his light armor leaves him vulnerable in close combat.');
define('U53DESC', 'The Spotter is the Hun scout unit. Swift and stealthy, he is sent ahead of the main army to spy on enemy villages. He cannot carry resources and is not meant for combat, but his speed allows him to gather crucial intelligence about enemy troop concentrations and defenses.');
define('U54DESC', 'The Steppe Rider is a light cavalryman born and raised on the vast plains. His speed and mobility make him an excellent raider, capable of striking enemy resource shipments and isolated villages. While lightly armored, his charge packs a considerable punch.');
define('U55DESC', 'The Marksman is a mounted archer who combines the mobility of cavalry with ranged attack. His composite bow allows him to rain arrows upon the enemy while staying out of reach. He is the backbone of the Hun offensive army, offering both solid attack and respectable defense.');
define('U56DESC', 'The Marauder is the elite cavalry of the Huns. Heavily armed and riding the fiercest steeds, these warriors are the terror of the battlefield. Their charge can shatter enemy lines, and they excel at plundering undefended villages. Expensive but devastating in large numbers.');
define('U57DESC', 'The Hun Ram is a simple but effective siege weapon. Built from timber scavenged from conquered lands, it is used to batter down enemy walls and gates. While slow and vulnerable, it can level even the strongest fortifications given enough time.');
define('U58DESC', 'The Catapult is the Hun siege engine designed to destroy enemy buildings from a distance. It can be aimed at specific structures to cripple a village\'s economy or military production. Its slow speed is compensated by the devastating precision of its shots.');
define('U59DESC', 'The Logades is the Hun chieftain and diplomat. Sent to enemy villages to undermine loyalty, he can convince the populace to switch allegiance through a combination of threats and promises. He is the key to conquering enemy villages without destroying them.');
define('U60DESC', 'The Settler is a pioneer who leaves the safety of the village to establish new settlements. Carrying a large wagon of supplies, he can found a new village in unclaimed lands. He is essential for any Hun who wishes to expand their realm beyond a single village.');
define('U61DESC', 'The Slave Militia forms the backbone of the Egyptian defensive army. These conscripted workers are given basic weapons and sent to defend the village. Their training is very cheap and fast, making them ideal for mass defense. While individually weak, their numbers can overwhelm any attacker.');
define('U62DESC', 'The Ash Warden is a seasoned Egyptian infantryman. Armed with a spear and shield, he provides solid defense against both infantry and cavalry. His balanced training makes him a reliable all-around defender for any Egyptian village.');
define('U63DESC', 'The Khopesh Warrior is the elite offensive infantry of Egypt. Wielding the distinctive curved sword, he can deliver devastating blows in close combat. His attack power rivals that of many cavalry units, making him a versatile asset for both defense and offense.');
define('U64DESC', 'The Sopdu Explorer is the Egyptian scout. Named after the god of the desert, he moves swiftly across the sands to observe enemy movements. He cannot fight or carry resources, but his keen eyes can uncover the secrets of any village.');
define('U65DESC', 'The Anhur Guard is a heavily armored Egyptian cavalry unit. Named after the god of war, he is the premier defensive cavalry in the game. His exceptional infantry defense makes him a formidable wall against enemy assaults, and his presence alone can deter many attackers.');
define('U66DESC', 'The Resheph Chariot is the premier Egyptian war chariot. Its crew combines spear and bow to create a mobile fortress. With outstanding defensive stats across the board, it is one of the most reliable defensive units in the game, capable of holding the line against any attacker.');
define('U67DESC', 'The Egyptian Ram is a sturdy siege engine designed to break down enemy fortifications. Its reinforced construction makes it more resilient than standard rams. While it moves slowly across the battlefield, its impact on enemy walls is devastating.');
define('U68DESC', 'The Stone Catapult is a massive Egyptian siege weapon engineered to hurl enormous stone projectiles. It excels at destroying enemy buildings and fortifications from a safe distance. Its high cost and slow speed are offset by its exceptional destructive power.');
define('U69DESC', 'The Nomarch is the Egyptian provincial governor and diplomat. His authority and eloquent speeches can sway the loyalty of enemy villages. He is the administrative counterpart to the Hun Logades, able to bring enemy settlements under Egyptian rule through persuasion and political maneuvering.');
define('U70DESC', 'The Egyptian Settler ventures forth into the desert to establish new outposts of the empire. Carrying ample provisions, he can found a new village in even the most barren lands. He is essential for expanding Egyptian influence across the map.');
define('U71DESC', 'The Hoplite is the iconic Spartan infantryman. Armed with a long spear and heavy shield, he fights in a phalanx formation that is nearly impenetrable. His balanced attack and defense make him a versatile soldier, capable of holding the line or advancing on enemy positions.');
define('U72DESC', 'The Sentinel is the Spartan scout. Disciplined and observant, he moves ahead of the army to gather intelligence. Though not as fast as other scouts, his training makes him harder to detect. He provides critical information about enemy forces and village layouts.');
define('U73DESC', 'The Shieldsman is the dedicated defender of the Spartan army. His massive hoplon shield provides exceptional protection against infantry attacks. Forming the backbone of the defensive line, he can hold positions against overwhelming odds.');
define('U74DESC', 'The Twinsteel Therion is a fearsome Spartan warrior wielding dual swords. His aggressive fighting style makes him a powerful offensive infantry unit. He can cut through enemy lines with devastating speed, though his lighter armor leaves him more vulnerable than the Shieldsman.');
define('U75DESC', 'The Elpida Rider is the Spartan defensive cavalry. Named after the goddess of hope, these riders patrol the borders and respond to threats. Their exceptional infantry defense makes them ideal for reinforcing villages under attack.');
define('U76DESC', 'The Corinthian Crusher is the elite Spartan heavy cavalry. Mounted on the finest warhorses and clad in bronze armor, these knights deliver earth-shattering charges. Their attack power is immense, making them the ultimate offensive weapon in the Spartan arsenal.');
define('U77DESC', 'The Spartan Ram is a heavy siege engine built to breach the formidable walls of enemy cities. Its bronze-tipped head can shatter stone, making it particularly effective against fortified settlements. Spartan discipline ensures the crew operates with maximum efficiency.');
define('U78DESC', 'The Ballista is the Spartan precision siege weapon. It fires large bolts with incredible accuracy, capable of targeting specific buildings within an enemy village. Its mechanical design allows for rapid reloading compared to traditional catapults.');
define('U79DESC', 'The Ephor is the Spartan magistrate and diplomat. Elected to oversee the city\'s affairs, he can be sent to enemy villages to sway the populace through rhetoric and intimidation. His authority makes him an effective agent of conquest, bringing new territories under Spartan control.');
define('U80DESC', 'The Spartan Settler leaves the mother city to found new colonies. Trained in both agriculture and warfare, he can establish a self-sufficient settlement anywhere. Each new colony strengthens Sparta\'s presence and brings more resources to the growing empire.');
define('U81DESC', 'The Thrall is the basic Viking infantry. Though born into servitude, these fierce warriors fight with surprising ferocity. Armed with simple axes, they are cheap to train and effective in large numbers. They form the backbone of any Viking raiding party.');
define('U82DESC', 'The Shield Maiden is a Viking warrior woman trained in the art of defense. Wielding a round shield and short sword, she provides reliable protection for the village. Her skills make her a valuable defender, capable of holding her ground against superior numbers.');
define('U83DESC', 'The Berserker is the shock infantry of the Viking army. Working himself into a frenzy before battle, he fights with reckless abandon, striking fear into enemy hearts. His attack power far exceeds what his light armor would suggest, making him a fearsome offensive unit.');
define('U84DESC', 'Heimdall\'s Eye is the Viking scout, named after the watchman of the gods who sees all. These keen-eyed scouts range far ahead of the fleet, reporting on enemy positions and village defenses. Their information is vital for planning successful raids.');
define('U85DESC', 'The Huskarl Rider is the Viking bodyguard cavalry. These elite household troops are sworn to protect their chieftain and village. Their sturdy round shields and chainmail provide excellent defense, making them reliable guardians of the Viking homeland.');
define('U86DESC', 'The Valkyrie\'s Blessing is the elite Viking cavalry. Named after the choosers of the slain, these mounted warriors ride into battle with divine fury. Their attack power is exceptional, capable of devastating enemy formations and carrying the day in battle.');
define('U87DESC', 'The Viking Ram is a sturdy battering ram, often transported on longships for coastal raids. Its iron-tipped head can crack open the strongest gates. Vikings use these to break into villages and plunder their riches before the defenders can organize.');
define('U88DESC', 'The Viking Catapult is a fearsome siege engine that hurls flaming projectiles at enemy villages. It can target specific buildings to maximize damage, crippling a village\'s economy before the main assault. Its psychological impact is as great as its physical destruction.');
define('U89DESC', 'The Jarl is the Viking noble and chieftain. As a respected leader, he can negotiate with enemy villages and convince them to pledge allegiance to his clan. His authority and reputation make him a powerful tool for expansion and conquest.');
define('U90DESC', 'The Viking Settler braves the treacherous seas to discover and colonize new lands. Carrying tools, seeds, and building materials, he can establish a thriving settlement wherever his longship lands. His pioneering spirit drives the expansion of Viking civilization.');
...
define('BOUNTY_TOTAL', 'Total bounty');
...
define('OWN_TROOPS_TOTAL', 'Total troops');
define('ON', 'on');
define('AT', 'at');
...
define('VILLAGE_OF_THE_ELDERS_TROOPS', 'Reinforcement from the Elders');
...
define('ENOUGH_TOTAL_RESOURCES', 'Enough to trade');
define('TOTAL_RESOURCE_MISSING', 'Resource missing:');
...
define('NOPREREQUISITES', 'No prerequisites');
...
<img src="/gpack/travian_default/img/x.gif" class="ArtefactsAnnouncement">
...
<img src="/gpack/travian_default/img/x.gif" class="WWVillagesAnnouncement" title="'.WWVILLAGE.'" alt="'.WWVILLAGE.'">
...
<img src="/gpack/travian_default/img/x.gif" class="WWBuildingPlansAnnouncement" title="'.PLAN.'" alt="'.PLAN.'">
