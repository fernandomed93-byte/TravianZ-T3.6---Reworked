    ...
    *****************************************/
    ...
    function getProfileVillages($uid, $mode = 0, $use_cache = true)
    {
        ...
        switch ($mode) {
            ...
            case 8:
                $q = "SELECT * FROM " . TB_PREFIX . "vdata WHERE owner IN(" . implode(', ', $uid) . ") ORDER BY name ASC";
                break;

            case 9:
                $q = "SELECT wref, owner FROM " . TB_PREFIX . "vdata WHERE wref IN(" . implode(', ', $uid) . ")";
                break;
        }
    ...
    function loadFullVillageData($wid)
    {
        ...
        $r3a = $this->mysqli_fetch_all(mysqli_query(
            $this->dblink,
