...
<?php echo MASS_READ; ?>
<a href="#" onclick="smilie('*u1*')"><img src="gpack/travian_default/img/x.gif" class="uu1" /></a>
<a href="#" onclick="smilie('*u2*')"><img src="gpack/travian_default/img/x.gif" class="uu2" /></a>
<a href="#" onclick="smilie('*u3*')"><img src="gpack/travian_default/img/x.gif" class="uu3" /></a>
<a href="#" onclick="smilie('*u4*')"><img src="gpack/travian_default/img/x.gif" class="uu4" /></a>
<a href="#" onclick="smilie('*u5*')"><img src="gpack/travian_default/img/x.gif" class="uu5" /></a>
<a href="#" onclick="smilie('*u6*')"><img src="gpack/travian_default/img/x.gif" class="uu6" /></a>
<a href="#" onclick="smilie('*u7*')"><img src="gpack/travian_default/img/x.gif" class="uu7" /></a>
<a href="#" onclick="smilie('*u8*')"><img src="gpack/travian_default/img/x.gif" class="uu8" /></a>
<a href="#" onclick="smilie('*u9*')"><img src="gpack/travian_default/img/x.gif" class="uu9" /></a>
<a href="#" onclick="smilie('*u10*')"><img src="gpack/travian_default/img/x.gif" class="uu10" /></a>
<a href="#" onclick="smilie('*u11*')"><img src="gpack/travian_default/img/x.gif" class="uu11" /></a>
<a href="#" onclick="smilie('*u12*')"><img src="gpack/travian_default/img/x.gif" class="uu12" /></a><br />
<a href="#" onclick="smilie('*u13*')"><img src="gpack/travian_default/img/x.gif" class="uu13" /></a>
<a href="#" onclick="smilie('*u14*')"><img src="gpack/travian_default/img/x.gif" class="uu14" /></a>
<a href="#" onclick="smilie('*u15*')"><img src="gpack/travian_default/img/x.gif" class="uu15" /></a>
<a href="#" onclick="smilie('*u16*')"><img src="gpack/travian_default/img/x.gif" class="uu16" /></a>
<a href="#" onclick="smilie('*u17*')"><img src="gpack/travian_default/img/x.gif" class="uu17" /></a>
<a href="#" onclick="smilie('*u18*')"><img src="gpack/travian_default/img/x.gif" class="uu18" /></a>
<a href="#" onclick="smilie('*u19*')"><img src="gpack/travian_default/img/x.gif" class="uu19" /></a>
<a href="#" onclick="smilie('*u21*')"><img src="gpack/travian_default/img/x.gif" class="uu21" /></a>
<a href="#" onclick="smilie('*u22*')"><img src="gpack/travian_default/img/x.gif" class="uu22" /></a>
<a href="#" onclick="smilie('*u23*')"><img src="gpack/travian_default/img/x.gif" class="uu23" /></a>
<a href="#" onclick="smilie('*u24*')"><img src="gpack/travian_default/img/x.gif" class="uu24" /></a><br />
<a href="#" onclick="smilie('*u25*')"><img src="gpack/travian_default/img/x.gif" class="uu25" /></a>
<a href="#" onclick="smilie('*u26*')"><img src="gpack/travian_default/img/x.gif" class="uu26" /></a>
<a href="#" onclick="smilie('*u29*')"><img src="gpack/travian_default/img/x.gif" class="uu29" /></a>
</div>
<?php } ?>
