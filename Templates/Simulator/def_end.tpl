			...
			<td class="details">
				<table cellpadding="1" cellspacing="1">
					<tr>
					    ...
					    <td class="value"><input class="text" type="text" name="ew2" value="<?php echo $form->getValue('ew2')==""? 1 : $form->getValue('ew2'); ?>" maxlength="6" title="number Population" /></td>

					    <td class="research"></td>
				    </tr>
					<tr>
					    <td class="ico"><img src="gpack/travian_default/img/x.gif" class="unit upal" alt="Stonemason's Lodge" title="Stonemason's Lodge" /></td>
                    ...
                    echo "<tr>
						    <td class=\"ico\"><img src=\"gpack/travian_default/img/x.gif\" class=\"unit uwall\" alt=\"City Wall\" title=\"City Wall\" /></td>
                    ...
                    echo "<tr>
						    <td class=\"ico\"><img src=\"gpack/travian_default/img/x.gif\" class=\"unit ubarr\" alt=\"Earth Wall\" title=\"Earth Wall\" /></td>
                    ...
                    echo "<tr>
						    <td class=\"ico\"><img src=\"gpack/travian_default/img/x.gif\" class=\"unit ustock\" alt=\"Palisade\" title=\"Palisade\" /></td>
                    ...
                    ?>
                        <tr>
					    <td class="ico"><img src="gpack/travian_default/img/x.gif" class="unit upal" alt="Palace" title="Palace" /></td>
