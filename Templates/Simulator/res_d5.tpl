				...
				<thead>
					<tr>
						<td class="role">
                            ...
                            <img src="gpack/travian_default/img/x.gif" class="unit u41" title="Pikeman" alt="Pikeman" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u42" title="Thorned Warrior" alt="Thorned Warrior" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u43" title="Guardsman" alt="Guardsman" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u44" title="Birds Of Prey" alt="Birds Of Prey"r" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u45" title="Axerider" alt="Axerider" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u46" title="Natarian Knight" alt="Natarian Knight" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u47" title="War Elephant" alt="War Elephant" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u48" title="Ballista" alt="Ballista" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u49" title="Natarian Emperor" alt="Natarian Emperor" />
                        </td><td>
                            <img src="gpack/travian_default/img/x.gif" class="unit u50" title="Natarian Settler" alt="Natarian Settler" />
                        </td>
				</thead>
				<tbody>
					<tr>
