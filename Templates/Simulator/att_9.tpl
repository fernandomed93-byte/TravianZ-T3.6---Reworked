				...
				<table cellpadding="1" cellspacing="1"><tr>
							...
							<td class="desc">
								Thrall
									...
									<input class="text" type="text" name="a1_1" value="<?php echo $form->getValue('a1_1'); ?>" maxlength="10" title="Number Thrall" />
								</td>
								<td class="research">
									<input class="text" type="text" name="f1_1" value="<?php echo $form->getValue('f1_1'); ?>"  maxlength="2" title="Level Blacksmith Thrall" />
								</td></tr><tr>
							<td class="ico">
							...
							<td class="desc">
								Shield Maiden
									...
									<input class="text" type="text" name="a1_2" value="<?php echo $form->getValue('a1_2'); ?>" maxlength="10" title="Number Shield Maiden" />
								</td>
								<td class="research">
									<input class="text" type="text" name="f1_2" value="<?php echo $form->getValue('f1_2'); ?>"  maxlength="2" title="Level Blacksmith Shield Maiden" />
							...
							<td class="desc">
								Berserker
									...
									<input class="text" type="text" name="a1_3" value="<?php echo $form->getValue('a1_3'); ?>" maxlength="10" title="Number Berserker" />
								</td>

								<td class="research">
									<input class="text" type="text" name="f1_3" value="<?php echo $form->getValue('f1_3'); ?>"  maxlength="2" title="Level Blacksmith Berserker" />
								</td></tr><tr>
							<td class="ico">
							...
							<td class="desc">
								Heimdall's Eye
									...
									<input class="text" type="text" name="a1_4" value="<?php echo $form->getValue('a1_4'); ?>" maxlength="10" title="Number Heimdall's Eye" />
								</td>
								<td class="research">
									<input class="text" type="text" name="f1_4" value="<?php echo $form->getValue('f1_4'); ?>"  maxlength="2" title="Level Blacksmith Heimdall's Eye" />
								</td></tr><tr>
							<td class="ico">
							...
							<td class="desc">
								...
								Huskarl Rider
									...
									<input class="text" type="text" name="a1_5" value="<?php echo $form->getValue('a1_5'); ?>" maxlength="10" title="Number Huskarl Rider" />
								</td>
								<td class="research">
									<input class="text" type="text" name="f1_5" value="<?php echo $form->getValue('f1_5'); ?>"  maxlength="2" title="Level Blacksmith Huskarl Rider" />
								</td></tr><tr>
							<td class="ico">
							...
							<td class="desc">
								Valkyrie's Blessing
									...
									<input class="text" type="text" name="a1_6" value="<?php echo $form->getValue('a1_6'); ?>" maxlength="10" title="Number Valkyrie's Blessing" />
								</td>
								<td class="research">
									<input class="text" type="text" name="f1_6" value="<?php echo $form->getValue('f1_6'); ?>"  maxlength="2" title="Level Blacksmith Valkyrie's Blessing" />
								</td></tr><tr>
							...
							<td class="desc">
								Jarl
									...
									<input class="text" type="text" name="a1_9" value="<?php echo $form->getValue('a1_9'); ?>" maxlength="6" title="Number Jarl" />
								</td>
		...
		<tr>
			<td class="details">
				<table cellpadding="1" cellspacing="1">
					<tr>
						<td class="ico"><img src="gpack/travian_default/img/x.gif" class="unit uhab" alt="Population" title="Population" /></td>
					...
					<tr>
						<td class="ico"><img src="gpack/travian_default/img/x.gif" class="unit ucata" alt="catapult target" title="catapult target" /></td>
						...
						<td class="research"></td>
                            ...
                            <td class="ico"><img src="gpack/travian_default/img/x.gif" class="unit uhero" title="Hero" alt="Hero" /></td>
