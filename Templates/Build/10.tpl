...
<div id="build" class="gid10"><a href="#" onClick="return Popup(10,4);" class="build_logo">
	<img class="building g10" src="gpack/travian_default/img/x.gif" alt="Warehouse" title="<?php echo WAREHOUSE; ?>" />
</a>
...
<p class="build_desc"><?php echo WAREHOUSE_DESC; ?></p>
	...
	<tr>
		...
		if ($village->resarray['f'.$id] == 0){
			...
			echo $bid10[$village->resarray['f'.$id]]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?></td><?php
		}
?>
	</tr>
	<tr>
