...
\*-------------------------------------------------------*/
	...
	foreach ($heroes as $hero_datarow) {
        ...
        <thead>
			...
			<?php
                ...
                <td class=\"desc\">
					<div class=\"tit\">
						<img class=\"unit u".$hero_datarow['unit']."\" src=\"gpack/travian_default/img/x.gif\" alt=\"".$name."\" title=\"".$name."\" />
						$name ($name1)
					</div>"
			?>
	...
	<?php }else if (!$reviving) if(in_array($hero_datarow['unit'], [1, 11, 21])){ ?>
        <tr>
                <td class="desc">
					<div class="tit">
						<img class="unit u<?php echo $hero_datarow['unit']; ?>" src="gpack/travian_default/img/x.gif" alt="<?php echo $name; ?>" title="<?php echo $name; ?>" />
						<?php echo $name." (Level ".$hero_datarow['level'].")"; ?>
					</div>
					<div class="details">
						<img class="r1" src="gpack/travian_default/img/x.gif" alt="Wood" title="<?php echo LUMBER; ?>" /><?php echo $wood; ?>|
                        <img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="<?php echo CLAY; ?>" /><?php echo $clay; ?>|
                        <img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="<?php echo IRON; ?>" /><?php echo $iron; ?>|
                        <img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="<?php echo CROP; ?>" /><?php echo $crop; ?>|
                        <img class="r5" src="gpack/travian_default/img/x.gif" alt="Crop consumption" title="<?php echo CROP_COM; ?>" />6|
                        <img class="clock" src="gpack/travian_default/img/x.gif" alt="Duration" title="<?php echo DURATION; ?>" />
				        ...
				        <?php
                            ...
                            if($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) >= 1 && $village->atotal >= $total_required) {
                   				echo "|<a href=\"build.php?gid=17&t=3&r1=".$wood."&r2=".$clay."&r3=".$iron."&r4=".$crop."\" title=\"NPC trade\"><img class=\"npc\" src=\"gpack/travian_default/img/x.gif\" alt=\"NPC trade\" title=\"NPC trade\" /></a>";
                 			}
				        ?>
                    </div>
				</td>
