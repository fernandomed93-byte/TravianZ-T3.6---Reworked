...
<p class="build_desc">
	<a href="#" onClick="return Popup(36,4, 'gid');"
		...
		class="building g36"
		src="gpack/travian_default/img/x.gif" alt="Trapper"
...
<table cellpadding="1" cellspacing="1" class="build_details">
	...
	<tbody>
		...
		<tr>
			<td class="desc">
			<div class="tit"><img class="unit u99" src="gpack/travian_default/img/x.gif"
				alt="Trap"
				title="Trap" /> <a href="#"
				onClick="return Popup(36,4,'gid');"><?php echo TRAP; ?></a> <span class="info">(<?php echo AVAILABLE; ?>: <?php echo $village->unitarray['u99']; ?>)</span>
			</div>
			<div class="details">
			<span><img class="r1" src="gpack/travian_default/img/x.gif"
				alt="Lumber" title="<?php echo LUMBER; ?>" />20|</span><span><img class="r2" src="gpack/travian_default/img/x.gif"
				alt="Clay" title="<?php echo CLAY; ?>" />30|</span><span><img class="r3" src="gpack/travian_default/img/x.gif"
				alt="Iron" title="<?php echo IRON; ?>" />10|</span><span><img class="r4" src="gpack/travian_default/img/x.gif"
				alt="Crop" title="<?php echo CROP; ?>" />20|</span><span><img class="r5" src="gpack/travian_default/img/x.gif" alt="Crop consumption"
				title="<?php echo CROP_COM; ?>" />0|<img class="clock" src="gpack/travian_default/img/x.gif"
	...
	<p><input type="image" id="btn_train" class="dynamic_img" value="ok" name="s1" src="gpack/travian_default/img/x.gif" alt="train" onclick="this.disabled=true;this.form.submit();"/></p></form>
	<?php
	} else {
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        foreach($trainlist as $train) {
			...
			echo "<img class=\"unit u".$train['unit']."\" src=\"gpack/travian_default/img/x.gif\" alt=\"".U99."\" title=\"".U99."\" />";
