...
<div id="build" class="gid39"><a href="#" onClick="return Popup(39,4);" class="build_logo">
	<img class="building g39" src="gpack/travian_default/img/x.gif" alt="Great Granary" title="<?php echo GREATGRANARY; ?>" />
</a>
...
<p class="build_desc"><?php echo GREATGRANARY_DESC; ?></p>
	...
	<tr>
		...
		if ($village->resarray['f'.$id] == 0){
			echo "0"; ?></b> <?php echo CROP_UNITS; ?></td><?php
		}else{
			echo $bid39[$village->resarray['f'.$id]]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo CROP_UNITS; ?></td><?php
		}
?>
	</tr>
