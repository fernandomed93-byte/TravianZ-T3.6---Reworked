<div id="build" class="gid17"><a href="#" onClick="return Popup(17,4);" class="build_logo"> 
	<img class="building g17" src="gpack/travian_default/img/x.gif" alt="Marketplace" title="<?php echo MARKETPLACE;?>" /> 
</a> 
...
$_POST['r1'] = (isset($_POST['r1']) && is_numeric($_POST['r1'])) ? (int)$_POST['r1'] : 0;
$_POST['r2'] = (isset($_POST['r2']) && is_numeric($_POST['r2'])) ? (int)$_POST['r2'] : 0;
$_POST['r3'] = (isset($_POST['r3']) && is_numeric($_POST['r3'])) ? (int)$_POST['r3'] : 0;
$_POST['r4'] = (isset($_POST['r4']) && is_numeric($_POST['r4'])) ? (int)$_POST['r4'] : 0;
...
<table id="send_select" class="send_res" cellpadding="1" cellspacing="1">
	<tr>
		<td class="ico"><img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="<?php echo LUMBER;?>" /></td> 
    ...
    <tr> 
		<td class="ico"><img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="<?php echo CLAY;?>" /></td> 
    ...
    <tr> 
		<td class="ico"><img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="<?php echo IRON;?>" /></td> 
    ...
    <tr> 
		<td class="ico"><img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="<?php echo CROP;?>" /></td> 
...
<table id="target_validate" class="res_target" cellpadding="1" cellspacing="1">
	...
	<tr>
		...
		<td><?php
		$resR1 = isset($_POST['r1']) && $_POST['r1'] > 0 ? $_POST['r1'] : 0;
		$resR2 = isset($_POST['r2']) && $_POST['r2'] > 0 ? $_POST['r2'] : 0;
		$resR3 = isset($_POST['r3']) && $_POST['r3'] > 0 ? $_POST['r3'] : 0;
		$resR4 = isset($_POST['r4']) && $_POST['r4'] > 0 ? $_POST['r4'] : 0;

        $resource = array($resR1,$resR2,$resR3,$resR4); 
...
<div class="clear"></div>
<p>
<div class="clear"></div><p><input type="image" value="ok" name="s1" id="btn_ok" class="dynamic_img" src="gpack/travian_default/img/x.gif" tabindex="8" alt="OK" <?php if(!$market->merchantAvail()) { echo "DISABLED"; }?>/></p></form>
<?php }else{ ?>
<form method="POST" name="snd" action="build.php"> 
...
<table id="send_select" class="send_res" cellpadding="1" cellspacing="1"><tr> 
		<td class="ico"> 
			<a href="#" onClick="upd_res(1,1); return false;"><img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="<?php echo LUMBER;?>" /></a> 
		</td> 
		<td class="nam"> 
			<?php echo LUMBER;?>:
		</td> 
		...
		<td class="ico"> 
			<a href="#" onClick="upd_res(2,1); return false;"><img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="<?php echo CLAY;?>" /></a> 
		</td> 
		<td class="nam"> 
			<?php echo CLAY;?>:
		</td> 
		...
		<td class="ico"> 
			<a href="#" onClick="upd_res(3,1); return false;"><img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="<?php echo IRON;?>" /></a> 
		</td> 
		<td class="nam"> 
			<?php echo IRON;?>:
		</td> 
		...
		<td class="ico"> 
			<a href="#" onClick="upd_res(4,1); return false;"><img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="<?php echo CROP;?>" /></a> 
		</td> 
		<td class="nam"> 
			<?php echo CROP;?>:
		</td> 
...
?>
<p><input type="image" value="ok" name="s1" id="btn_ok" class="dynamic_img" src="gpack/travian_default/img/x.gif" tabindex="8" alt="OK" <?php if(!$market->merchantAvail()) { echo "DISABLED"; }?>/></p></form>
<?php
$error = '';
...
$totalCropComing = 0;
    foreach($market->recieving as $recieve) {
		...
		echo "<img class=\"r1\" src=\"gpack/travian_default/img/x.gif\" alt=\"Lumber\" title=\"".LUMBER."\" />".$recieve['wood']." | <img class=\"r2\" src=\"gpack/travian_default/img/x.gif\" alt=\"Clay\" title=\"".CLAY."\" />".$recieve['clay']." | <img class=\"r3\" src=\"gpack/travian_default/img/x.gif\" alt=\"Iron\" title=\"".IRON."\" />".$recieve['iron']." | <img class=\"r4\" src=\"gpack/travian_default/img/x.gif\" alt=\"Crop\" title=\"".CROP."\" />".$recieve['crop']."</td></tr></tbody>";
		echo "</table>";
		$totalCropComing += $recieve['crop'];
    }
	//echo $totalCropComing;
}
if(count($market->sending) > 0) {
    ...
    foreach($market->sending as $send) {
        ...
        echo "<img class=\"r1\" src=\"gpack/travian_default/img/x.gif\" alt=\"Lumber\" title=\"".LUMBER."\" />".$send['wood']." | <img class=\"r2\" src=\"gpack/travian_default/img/x.gif\" alt=\"Clay\" title=\"".CLAY."\" />".$send['clay']." | <img class=\"r3\" src=\"gpack/travian_default/img/x.gif\" alt=\"Iron\" title=\"".IRON."\" />".$send['iron']." | <img class=\"r4\" src=\"gpack/travian_default/img/x.gif\" alt=\"Crop\" title=\"".CROP."\" />".$send['crop']."</td></tr></tbody>";
        echo "</table>";
    }
}
