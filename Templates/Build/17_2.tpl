...
<form method="POST" action="build.php">  
    ...
    ?> 
    <input type="image" tabindex="8" value="ok" name="s1" id="btn_ok" class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="OK" <?php //if(!$market->merchantAvail()) { echo "DISABLED"; }?>/></p> 
</form> 
<?php 
...
{ 
    ...
    { 
        ...
        { 
            echo "<tr><td class=\"abo\"><a href=\"build.php?id=$id&t=2&a=5&del=".$offer['id']."\"><img class=\"del\"src=\"gpack/travian_default/img/x.gif\" alt=\"Delete\" title=\"".DELETE."\" /></a></td>"; 
            echo "<td class=\"val\">"; 
        } 
        else 
        { 
            echo "<tr><td class=\"abo\"><a href=\"banned.php\"><img class=\"del\"src=\"gpack/travian_default/img/x.gif\" alt=\"Delete\" title=\"".DELETE."\" /></a></td>"; 
            echo "<td class=\"val\">"; 
        } 
        switch($offer['gtype']) 
        { 
