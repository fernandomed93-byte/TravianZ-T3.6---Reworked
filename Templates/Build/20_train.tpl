<?php
$success = 0;
$start = ($session->tribe - 1) * 10 + 4 - (($session->tribe == 3) ? 1 : 0) + (($session->tribe == 2) ? 1 : 0 ) + (($session->tribe == 8) ? 1 : 0 ) + (($session->tribe == 9) ? 1 : 0 );
