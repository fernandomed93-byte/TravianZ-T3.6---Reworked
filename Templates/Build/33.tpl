...
include("next.tpl");
?>
<div id="build" class="gid33"><a href="#" onClick="return Popup(33,4);" class="build_logo">
    <img class="building g33" src="gpack/travian_default/img/x.gif" alt="Palisade" title="<?php echo PALISADE; ?>" />
</a>
