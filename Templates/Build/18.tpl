<div id="build" class="gid18"><a href="#" onClick="return Popup(18,4);" class="build_logo">
	<img class="building g18" src="gpack/travian_default/img/x.gif" alt="Embassy" title="<?php echo EMBASSY; ?>" />
</a>
...
<tbody><tr>
    ...
    if($alliance->gotInvite) {
    	foreach($alliance->inviteArray as $invite) {
        	 echo "<td class=\"abo\"><a href=\"build.php?id=".$id."&a=2&d=".$invite['id']."\"><img class=\"del\" src=\"gpack/travian_default/img/x.gif\" alt=\"refuse\" title=\"".REFUSE."\" /></a></td>
