 ...
 <tr><th><?php echo TROOPS;?></th>
		...
		<tbody class="infos">
			<tr>
				...
				?>
                    <div class="abort"><a href="build.php?id=<?php echo $_GET['id']."&mode=troops&cancel=1&moveid=".$units[$y]['moveid']; ?>"><img src="gpack/travian_default/img/x.gif" class="del" /></a></div>
					<?php } ?>
					</div>
				</td>
			</tr>
 ...
 <tr><th><?php echo TROOPS;?></th>
        ...
        <tbody class="infos">
            <tr>
				...
				?>
                    <div class="abort"><a href="build.php?id=<?php echo $_GET['id']."&mode=troops&cancel=1&moveid=".$settlers[$y]['moveid']; ?>"><img src="gpack/travian_default/img/x.gif" class="del" /></a></div>
					<?php } ?>
                    </div>
                </td>
            </tr>
