...
<div id="build" class="gid38"><a href="#" onClick="return Popup(38,4);" class="build_logo">
	<img class="building g38" src="gpack/travian_default/img/x.gif" alt="Great Warehouse" title="<?php echo GREATWAREHOUSE; ?>" />
</a>
...
?>
	...
	<tr>
		...
		if ($village->resarray['f'.$id] == 0){
			echo "0"; ?></b> <?php echo RESOURCE_UNITS; ?></td><?php
		}else{
			echo $bid38[$village->resarray['f'.$id]]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?></td><?php
		}
?>
	</tr>
	<tr>
