	...
	if($units[$y]['sort_type'] == 3){
		...
		if($units[$y]['attack_type'] != 1){
			if($units[$y]['from'] != 0){
				...
				if ($units[$y]['t11'] > 0){ //Herói presente no reforço
					$hasTroops = false;
...
<table class="troop_details" cellpadding="1" cellspacing="1">
	...
	<tbody class="units">
		...
		<tr>
			...
			echo "<div class=\"res\"><img class=\"r1\" src=\"gpack/travian_default/img/x.gif\" alt=\"Lumber\" title=\"Lumber\" />".$units[$y]['wood']." | <img class=\"r2\" src=\"gpack/travian_default/img/x.gif\" alt=\"Clay\" title=\"Clay\" />".$units[$y]['clay']." | <img class=\"r3\" src=\"gpack/travian_default/img/x.gif\" alt=\"Iron\" title=\"Iron\" />".$units[$y]['iron']." | <img class=\"r4\" src=\"gpack/travian_default/img/x.gif\" alt=\"Crop\" title=\"Crop\" />".$units[$y]['crop']."</div>";
