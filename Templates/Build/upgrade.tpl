...
<img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="Lumber" /><span class="little_res"><?php echo $uprequire['wood']; ?></span> | <img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="Clay" /><span class="little_res"><?php echo $uprequire['clay']; ?></span> | <img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="Iron" /><span class="little_res"><?php echo $uprequire['iron']; ?></span> | <img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="Crop" /><span class="little_res"><?php echo $uprequire['crop']; ?></span> | <img class="r5" src="gpack/travian_default/img/x.gif" alt="Crop consumption" title="Crop consumption" /><?php echo $uprequire['pop']; ?> | <img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /><?php echo $generator->getTimeFormat($uprequire['time']);
if($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) >= 1 && $village->atotal >= $total_required) {
    echo "| <a href=\"build.php?gid=17&t=3&r1=".$uprequire['wood']."&r2=".$uprequire['clay']."&r3=".$uprequire['iron']."&r4=".$uprequire['crop']."\" title=\"NPC trade\"><img class=\"npc\" src=\"gpack/travian_default/img/x.gif\" alt=\"NPC trade\" title=\"NPC trade\" /></a>";
}else if($session->userinfo['gold'] >= 3 && $building->getTypeLevel(17) >= 1 && $village->atotal < $total_required){
		$neededtimeTotal = $building->calculateAvaliableTotal($id,$village->resarray['f'.$id.'t'],1+$loopsame+$doublebuild+$master);
		echo "</br><span class=\"none\">".TOTAL_RESOURCE_MISSING." ".$total_required - $village->atotal."</br>".ENOUGH_TOTAL_RESOURCES." ".$neededtimeTotal[0]." at  ".$neededtimeTotal[1]."</span>";
} ?><br />
<?php
    if($bindicate == 2) {
