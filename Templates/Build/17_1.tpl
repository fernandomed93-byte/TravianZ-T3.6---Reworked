...
<tbody><tr>
<td <?php if(isset($_GET['s']) && $_GET['s'] == 1) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&s=1<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['b'])) echo "&b=".$_GET['b']; ?>"><img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="<?php echo LUMBER;?>" /></a></td>
<td <?php if(isset($_GET['s']) && $_GET['s'] == 2) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&s=2<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['b'])) echo "&b=".$_GET['b']; ?>"><img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="<?php echo CLAY;?>" /></a></td>
<td <?php if(isset($_GET['s']) && $_GET['s'] == 3) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&s=3<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['b'])) echo "&b=".$_GET['b']; ?>"><img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="<?php echo IRON;?>" /></a></td>
<td <?php if(isset($_GET['s']) && $_GET['s'] == 4) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&s=4<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['b'])) echo "&b=".$_GET['b']; ?>"><img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="<?php echo CROP;?>" /></a></td></tr></tbody>
...
<tbody><tr>
<td <?php if(isset($_GET['b']) && $_GET['b'] == 1) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&b=1<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['s'])) echo "&s=".$_GET['s']; ?>"><img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="<?php echo LUMBER;?>" /></a></td>
<td <?php if(isset($_GET['b']) && $_GET['b'] == 2) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&b=2<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['s'])) echo "&s=".$_GET['s']; ?>"><img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="<?php echo CLAY;?>" /></a></td>
<td <?php if(isset($_GET['b']) && $_GET['b'] == 3) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&b=3<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['s'])) echo "&s=".$_GET['s']; ?>"><img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="<?php echo IRON;?>" /></a></td>
<td <?php if(isset($_GET['b']) && $_GET['b'] == 4) echo "class=\"hl\""; ?>><a href="build.php?id=<?php echo $id; ?>&t=1&b=4<?php if(isset($_GET['v'])) echo "&v=".$_GET['v']; if(isset($_GET['s'])) echo "&s=".$_GET['s']; ?>"><img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="<?php echo CROP;?>" /></a></td></tr></tbody>
</table>
 <?php
 }
 ?>
...
switch($market->onsale[$i]['gtype']) {
    case 1: echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"r1\" alt=\"Wood\" title=\"".LUMBER."\" />"; break;
    case 2: echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"r2\" alt=\"Clay\" title=\"".CLAY."\" />"; break;
    case 3: echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"r3\" alt=\"Iron\" title=\"".IRON."\" />"; break;
    case 4: echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"r4\" alt=\"Crop\" title=\"".CROP."\" />"; break;
 	}
