...
<div id="build" class="gid11"><a href="#" onClick="return Popup(11,4);" class="build_logo">
	<img class="building g11" src="gpack/travian_default/img/x.gif" alt="Granary" title="<?php echo GRANARY; ?>" />
</a>
...
<p class="build_desc"><?php echo GRANARY_DESC; ?></p>
	...
	<tr>
		...
		if ($village->resarray['f'.$id] == 0){
			...
			echo $bid11[$village->resarray['f'.$id]]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo CROP_UNITS; ?></td><?php
		}
?>
	</tr>
