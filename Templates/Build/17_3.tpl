...
<p><b><?php echo NPC_COMPLETED;?>.</b> <?php echo COSTS;?> 3<img src="gpack/travian_default/img/x.gif" class="gold" alt="Gold" title="<?php echo GOLD;?>" /></p> 
	...
	<?php
		...
		<table id="npc" cellpadding="1" cellspacing="1"> 
			<thead> 
				...
				<tr>
			<td class="all"> 
				<a href="javascript:fillup(0);"><img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="<?php echo LUMBER;?>" /></a> 
				<span id="org0"><?php echo floor($village->awood); ?></span> 
			</td> 
		
			<td class="all"> 
				<a href="javascript:fillup(1);"><img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="<?php echo CLAY;?>" /></a> 
				<span id="org1"><?php echo floor($village->aclay); ?></span> 
			</td> 
		
			<td class="all"> 
				<a href="javascript:fillup(2);"><img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="<?php echo IRON;?>" /></a> 
				<span id="org2"><?php echo floor($village->airon); ?></span> 
			</td> 
		
			<td class="all"> 
				<a href="javascript:fillup(3);"><img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="<?php echo CROP;?>" /></a> 
		...
		<tbody> 
			...
			<td class="sel"> 
				<input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if(isset($_GET['r1'])) { echo "value=\"".$_GET['r1']."\""; } else { echo "value='0'"; } ?>/> 
				<input type="hidden" name="m1[]" value="<?php echo floor($village->awood); ?>" /> 
			</td> 
		
			<td class="sel"> 
				<input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if(isset($_GET['r2'])) { echo "value=\"".$_GET['r2']."\""; } else { echo "value='0'"; } ?>/> 
				<input type="hidden" name="m1[]" value="<?php echo floor($village->aclay); ?>" /> 
			</td> 
		
			<td class="sel"> 
				<input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if(isset($_GET['r3'])) { echo "value=\"".$_GET['r3']."\""; } else { echo "value='0'"; } ?>/> 
				<input type="hidden" name="m1[]" value="<?php echo floor($village->airon); ?>" /> 
			</td> 
		
			<td class="sel"> 
				<input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if(isset($_GET['r4'])) { echo "value=\"".$_GET['r4']."\""; } else { echo "value='0'"; } ?>/> 
		...
		<p id="submitButton"> 
	<?php if($session->userinfo['gold'] >= 3) { ?><a href="javascript:document.snd.submit();"><?php echo TRADE_RESOURCES;?>)</a> <span class="none">(<?php echo COSTS;?>: <img src="gpack/travian_default/img/x.gif" class="gold_g" alt="Gold" title="<?php echo GOLD;?>" /><b>3</b>)</span><?php } else { echo"<span class='none'>".TRADE_RESOURCES.")</span> (".COSTS.": <img src='gpack/travian_default/img/x.gif' class='gold' alt='Gold' title='".GOLD."' /><b>3</b>)"; }?>	</p>
		<p id="submitText"></p> 
		</form> 
		<script> 
			testSum();
