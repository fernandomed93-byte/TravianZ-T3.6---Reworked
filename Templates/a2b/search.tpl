...
<input type="hidden" name="disabled" value="<?php echo (isset($disabled) ? $disabled : ''); ?>">
    ...
    <tr>
        <td class="sel">
            <label>
				...
				value="3" type="radio" <?php echo $disabled; ?>
				<?php echo ($radselection == "3") ? 'checked="checked"' : ''; ?>
				>
                Normal attack
            </label>
        </td>
    ...
    <tr>
        <td class="sel">
            <label>
                <input class="radio" name="c" 
				<?php if ( ( isset($disabledr) && $disabledr ) && ( isset($disabled) && $disabled ) ) {
                    $checked = ' checked="checked"';
                  }
                  echo ( ( isset($checked) ? $checked : '' ) );
                ?>
				<?php echo ($radselection == "4") ? 'checked="checked"' : ''; ?>
				value="4" type="radio">
                Raid
            </label>
        </td>
...
<script type="text/javascript">
    document.getElementById('s1trops').submit(); // SUBMIT FORM
</script>
