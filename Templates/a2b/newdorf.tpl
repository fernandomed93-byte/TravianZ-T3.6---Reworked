...
<h1>Found new village</h1>
	...
	<tbody class="infos">
		<tr>
			<th>Duration</th>
				<td colspan="10"><img class="clock" src="gpack/travian_default/img/x.gif" alt="Duration" title="Duration" /> <?php echo $generator->getTimeFormat($time); ?></td>
		</tr>
	</tbody>
	<tbody class="infos">
		<tr>
			<th>Resources</th>
				<td colspan="10">
				<img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="Wood" />750 | 
				<img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="Clay" />750 | 
				<img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="Iron" />750 | 
				<img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="Crop" />750</td>
		</tr>
	</tbody>
</table>
<p class="btn">
