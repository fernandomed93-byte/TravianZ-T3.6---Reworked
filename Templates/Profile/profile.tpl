...
<form action="spieler.php" method="POST">
   ...
   ?>
    ...
    echo "<tr><th>Village name</th><td><input tabindex=\"6\" type=\"text\" name=\"dname[".$varray[$i]['wref']."]\" value=\"".$varray[$i]['name']."\" maxlength=\"30\" class=\"text\"></td></tr>";
    }
    ?>
...
******************************/
	...
	<p class="btn"><input type="image" value="" tabindex="9" name="s1" id="btn_ok" class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="OK" /></p>
    </form>
