            ...
            if(NEW_FUNCTIONS_OASIS){
                ...
                foreach ($oases as $oasis) {
                    switch ($oasis['type']) {
                        case 1:
                        case 2:
                            echo "<img class='r100' src='gpack/travian_default/img/x.gif' title='+25% Lumber'> ";
                            break;
                        case 3:
                            echo "<img class='r200' src='gpack/travian_default/img/x.gif' title='+25% Lumber +25% Crop'> ";
                            break;
                        case 4:
                        case 5:
                            echo "<img class='r400' src='gpack/travian_default/img/x.gif' title='+25% Clay'> ";
                            break;
                        case 6:
                            echo "<img class='r500' src='gpack/travian_default/img/x.gif' title='+25% Clay +25% Crop'> ";
                            break;
                        case 7:
                        case 8:
                            echo "<img class='r700' src='gpack/travian_default/img/x.gif' title='+25% Iron'> ";
                            break;
                        case 9:
                            echo "<img class='r800' src='gpack/travian_default/img/x.gif' title='+25% Iron +25% Crop'> ";
                            break;
                        case 10:
                        case 11:
                            echo "<img class='r1000' src='gpack/travian_default/img/x.gif' title='+25% Crop'> ";
                            break;
                        case 12:
                            echo "<img class='r1100' src='gpack/travian_default/img/x.gif' title='+50% Crop'> ";
                            break;
                    }
                }
                echo "</td>";
