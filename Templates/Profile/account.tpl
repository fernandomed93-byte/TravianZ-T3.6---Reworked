...
if($session->userinfo['sit1'] != 0) {
	echo "<div>";
    echo "<a href=\"spieler.php?s=3&e=3&id=".$session->userinfo['sit1']."&a=".$session->checker."&type=1\"><img class=\"del\" src=\"gpack/travian_default/img/x.gif\" title=\"Remove sitters\" alt=\"Remove sitters\" /></a>";
...
echo "<div>";
echo "<a href=\"spieler.php?s=3&e=3&id=".$session->userinfo['sit2']."&a=".$session->checker."&type=2\"><img class=\"del\" src=\"gpack/travian_default/img/x.gif\" title=\"Remove sitters\" alt=\"Remove sitters\" /></a>";
...
echo "<div>";
echo "<a href=\"spieler.php?s=3&e=2&id=".$sit['id']."&a=".$session->checker."\"><img class=\"del\" src=\"gpack/travian_default/img/x.gif\" title=\"Remove sitters\" alt=\"Remove sitters\" /></a>";
...
echo "<a href=\"spieler.php?s=3&id=".$session->uid."&a=1&e=4\"><img
		class=\"del\" src=\"gpack/travian_default/img/x.gif\" alt=\"Cancel process\"
...
?>
    <p class="btn"><input type="image" value="" name="s1" id="btn_save" class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="save" /></p>
</form>
