...
<div id="gpack_popup">
		...
		<div id="gpack_error">
			<img class="logo unknown" src="gpack/travian_default/img/x.gif" alt="unknown" title="unknown"><span class="error">Graphic Pack could not be found. This could be due to the following reasons:</span><br>
<ul>
...
<li>Your browser does not support Graphic Packs hosted on your computer and needs them to be online, with a path starting with '<b>http://</b>'.</li>
		...
		<div id="gpack_activate">
			...
			<img id="preview" src="gpack/travian_default/img/x.gif"><br>
