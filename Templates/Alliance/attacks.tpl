...
<h4 class="chartHeadline">Military events</h4>
		<div id="submenu">
			<a href="allianz.php?s=3&f=32">
				<img src="gpack/travian_default/img/x.gif" class="<?php echo isset($_GET['f']) && $_GET['f'] == 32 ? "active btn_def" : "btn_def";?>" alt="Defender" title="Defender" />
			</a>

			<a href="allianz.php?s=3&f=31">
				<img src="gpack/travian_default/img/x.gif" class="<?php echo isset($_GET['f']) && $_GET['f'] == 31 ? "active btn_off" : "btn_off";?>" alt="Attacker" title="Attacker" />
			</a>
		</div>
<?php
...
while($row = mysqli_fetch_array($sql)){ 
    ...
    $outputList .= "<img src=\"gpack/travian_default/img/x.gif\" class=\"iReport iReport$type\" title=\"".$topic."\">";
	}
    $outputList .= "</a>";
