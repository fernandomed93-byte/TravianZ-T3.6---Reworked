...
<script language="JavaScript" type="text/javascript">
    ...
    function addRow(element_id) {
		...
		newTD3.innerHTML = '<img class="add" src="gpack/travian_default/img/x.gif" title="add" alt="add" onclick="addRow(\''+element_id+'\')">';
    }
...
<table cellpadding="1" cellspacing="1" id="ally_list"><thead>
	...
	<tr>
		...
		<td class="ad">
			...
			<img class="add" src="gpack/travian_default/img/x.gif" title="add" alt="add" onclick="addRow('ally_list')" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ad">
			<img class="add" src="gpack/travian_default/img/x.gif" title="add" alt="add" onclick="addRow('user_list')" />
		</td>
	</tr>
</tbody></table>
<script language="JavaScript" type="text/javascript">
...
<?php } ?>
<p class="btn"><input type="image" id="fbtn_ok" value="ok" name="s1" class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="OK" /></p></form>