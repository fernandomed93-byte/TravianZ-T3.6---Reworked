...
$tribeArray = [TRIBE1, TRIBE2, TRIBE3, TRIBE6, TRIBE7, TRIBE8, TRIBE9];
...
if(Alliance::canAct($checkArray)){
	echo '<div class="admin"><a class="edit" href="allianz.php?s=2&idt='.$arr['id'].'&admin=editans"><img src="gpack/travian_default/img/x.gif" title="edit" alt="edit" /></a><a class="fdel" href="?s=2&fid='.$arr['cat'].'&idt='.$arr['id'].'&admin=deltopic" onClick="return confirm(\'confirm delete?\');"><img src="gpack/travian_default/img/x.gif" title="delete" alt="delete" /></a></div><br />';
}
?>
					...
					<div class="text">
						...
						<p class="btn">
							<input type="image" id="fbtn_vote" value="ok" name="s1"
								class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="Vote" />
...
foreach($posts as $po){
	...
	if(Alliance::canAct($checkArray)){
		echo '<div class="admin"><a class="edit" href="allianz.php?s=2&fid='.$topic['cat'].'&tid='.$_GET['tid'].'&pod='.$po['id'].'&admin=editpost"><img src="gpack/travian_default/img/x.gif" title="edit" alt="edit" /></a><a class="fdel" href="?s=2&pod='.$po['id'].'&tid='.$_GET['tid'].'&fid2='.$topic['cat'].'&admin=delpost" onClick="return confirm(\'confirm delete?\');"><img src="gpack/travian_default/img/x.gif" title="delete" alt="delete" /></a></div><br />';
	}
...
if(!$arr['close'] && ($forumData['forum_area'] != 3 || ($forumData['forum_area'] == 3 && $opt['opt5'] == 1))){
	echo '<a href="allianz.php?s=2&tid='.$arr['id'].'&ac=newpost"><img id="fbtn_reply" class="dynamic_img"src="gpack/travian_default/img/x.gif" alt="Replies" /></a>';
	echo '<a href="allianz.php?s=2&tid='.$arr['id'].((isset($_GET['admin']) && !empty($_GET['admin']) && $_GET['admin'] == "switch_admin") ? "" : "&admin=switch_admin").'" title="Toggle Admin mode"><img class="switch_admin dynamic_img" src="gpack/travian_default/img/x.gif" alt="Toggle Admin mode" /></a>';
}
?>
</div>