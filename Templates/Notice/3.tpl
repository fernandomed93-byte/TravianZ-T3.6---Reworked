...
$colspan = (isset($dataarray[276]) && $dataarray[276] > 0) ? 11 : 10;
$colspan2 = 10;
...
if(isset($dataarray[276]) && $dataarray[276] > 0){
...
if(isset($dataarray[270]) && $dataarray[270] > 0){
    ...
    echo "<td $tdclass>$dataarray[277]</td>";
}
if(array_sum(array_slice($dataarray, 274, 11)) > 0){
