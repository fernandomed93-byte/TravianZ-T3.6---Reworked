...
if($dataarray[13] > 0) echo "<td><img src=\"gpack/travian_default/img/x.gif\" class=\"unit uhero\" title=\"Hero\" /></td>";
...
<?php echo $technology->getUpkeep($unitarray, $dataarray[2]); ?><img src="gpack/travian_default/img/x.gif" class="r4" title="Crop" alt="Crop" />per hour</td>
</tr></tbody>
