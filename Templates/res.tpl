...
<div id="resWrap">
	...
	<table cellpadding="1" cellspacing="1">
		<tr>
							<td><img src="gpack/travian_default/img/x.gif" class="r1" alt="<?php echo LUMBER; ?>" title="<?php echo LUMBER; ?>" /></td>
				<td id="l4" title="<?php echo $wood; ?>"><?php echo round($village->awood)."/".$village->maxstore; ?></td>
							<td><img src="gpack/travian_default/img/x.gif" class="r2" alt="<?php echo CLAY; ?>" title="<?php echo CLAY; ?>" /></td>
				<td id="l3" title="<?php echo $clay; ?>"><?php echo round($village->aclay)."/".$village->maxstore; ?></td>
							<td><img src="gpack/travian_default/img/x.gif" class="r3" alt="<?php echo IRON; ?>" title="<?php echo IRON; ?>" /></td>
				<td id="l2" title="<?php echo $iron; ?>"><?php echo round($village->airon)."/".$village->maxstore; ?></td>
							<td><img src="gpack/travian_default/img/x.gif" class="r4" alt="<?php echo CROP; ?>" title="<?php echo CROP; ?>" /></td>
				...
				<td title="<?php echo $crop; ?>"><?php echo "0/".$village->maxcrop; ?></td>
							<?php } ?>
							<td><img src="gpack/travian_default/img/x.gif" class="r5" alt="<?php echo CROP_COM; ?>" title="<?php echo CROP_COM; ?>" /></td>
