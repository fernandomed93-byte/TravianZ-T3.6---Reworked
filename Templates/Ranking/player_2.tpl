...
<table cellpadding="1" cellspacing="1" id="player">
	<thead>
				<tr>
					<th colspan="5">
						The largest Teutons		<div id="submenu"><a title="Top 10" href="statistiken.php?id=7"><img class="btn_top10" src="gpack/travian_default/img/x.gif" alt="Top 10" /></a><a title="defender" href="statistiken.php?id=32"><img class="btn_def" src="gpack/travian_default/img/x.gif" alt="defender" /></a><a title="attacker" href="statistiken.php?id=31"><img class="btn_off" src="gpack/travian_default/img/x.gif" alt="attacker" /></a></div><br><div id="submenu2"><a title="Romans" href="statistiken.php?id=11"><img class="btn_v1" src="gpack/travian_default/img/x.gif" alt="attacker"></a><a title="Teutons" href="statistiken.php?id=12"><img class="active btn_v2" src="gpack/travian_default/img/x.gif" alt="attacker"></a><a title="Gauls" href="statistiken.php?id=13"><img class="btn_v3" src="gpack/travian_default/img/x.gif" alt="attacker"></a></div>    	    
					</th>
				</tr>
        ...
        if(count($rankArray) > 1 && $rankSize > 0) {
            foreach ($rankArray as $row) {
                ...
                echo"</td><td class=\"al\" >";
                if(isset($row['alliance']) && $row['alliance'] > 0) {
