			...
			<thead>
				<tr>
					<th colspan="5">
						...
						<div id="submenu"><a title="Top 10" href="statistiken.php?id=43"><img class="btn_top10" src="gpack/travian_default/img/x.gif" alt="Top 10" /></a>
						<a title="Defenders" href="statistiken.php?id=42"><img class="active btn_def" src="gpack/travian_default/img/x.gif" alt="Defenders" /></a>
