	...
	<thead>
		<tr>
			...
			<div id="submenu"><a title="Top 10" href="statistiken.php?id=43"><img class="active btn_top10" src="gpack/travian_default/img/x.gif" alt="Top 10"></a>
			<a title="Defenders" href="statistiken.php?id=42"><img class="btn_def" src="gpack/travian_default/img/x.gif" alt="Defenders"></a>
			<a title="Attackers" href="statistiken.php?id=41"><img class="btn_off" src="gpack/travian_default/img/x.gif" alt="Attackers"></a></div>
