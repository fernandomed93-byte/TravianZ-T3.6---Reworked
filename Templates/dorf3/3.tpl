...
<table id="warehouse" cellpadding="1" cellspacing="1">
	<thead>
		...
		<tr>
			<td>Village</td>
			<td><img class="r1" src="gpack/travian_default/img/x.gif" title="Wood" alt="Wood"></td>
			<td><img class="r2" src="gpack/travian_default/img/x.gif" title="Clay" alt="Clay"></td>
			<td><img class="r3" src="gpack/travian_default/img/x.gif" title="Iron" alt="Iron"></td>
			<td><img class="clock" src="gpack/travian_default/img/x.gif" title="Clock" alt="Clock"></td>
			<td><img class="r4" src="gpack/travian_default/img/x.gif" title="Crop" alt="Crop"></td>
			<td><img class="clock" src="gpack/travian_default/img/x.gif" title="Clock" alt="Clock"></td>
		</tr>
	</thead>
	<tbody>
...
foreach($varray as $vil){
	...
	if($OBwood != 0) {
		$prod_wood += $prod_wood*0.25*$OBwood;
	}
	if($OBclay != 0) {
		$prod_clay += $prod_clay*0.25*$OBclay;
	}
	if($OBiron != 0) {
		$prod_iron += $prod_iron*0.25*$OBiron;
	}
	if($OBcrop != 0) {
		$prod_crop += $prod_crop*0.25*$OBcrop;
	}
