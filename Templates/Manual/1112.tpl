<h1><img class="unit ugeb" src="gpack/travian_default/img/x.gif" alt="Alliance invitation message" title="Alliance invitation message" /> Alliance invitation message</h1>
