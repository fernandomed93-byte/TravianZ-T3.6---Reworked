<h1><img class="unit u23" src="gpack/travian_default/img/x.gif" alt="Pathfinder" title="Pathfinder" /> Pathfinder <span class="tribe">(Gauls)</span></h1>
...
<img id="big_unit" class="big_u23" src="gpack/travian_default/img/x.gif" alt="Pathfinder" title="Pathfinder" /><div id="t_desc">The Pathfinder is the Gaul's reconnaissance unit. They are very fast and they can carefully advance on the enemy units, resources or buildings to spy on them.
<br /><br />
