<h1><img class="unit u2" src="gpack/travian_default/img/x.gif" alt="Praetorian" title="Praetorian" /> Praetorian <span class="tribe">(Romans)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:29:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u2" src="gpack/travian_default/img/x.gif" alt="Praetorian" title="Praetorian" /><div id="t_desc">The Praetorians are the emperor's guard and they defend him with their life. Because their training is specialized for defence, they are very weak attackers.</div>
