<h1><img class="unit u13" src="gpack/travian_default/img/x.gif" alt="Axeman" title="Axeman" /> Axeman <span class="tribe">(Teutons)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:20:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u13" src="gpack/travian_default/img/x.gif" alt="Axeman" title="Axeman" /><div id="t_desc">This is the Teuton's strongest infantry unit. He is strong at both offence and defence but he is slower and more expensive than other units.</div>
