<h1><img class="unit u41" src="gpack/travian_default/img/x.gif" alt="Pikeman" title="Pikeman" /> Pikeman <span class="tribe">(Natars)</span></h1>
...
<img id="big_unit" class="big_u41" src="gpack/travian_default/img/x.gif" alt="Pikeman" title="Pikeman" /><div id="t_desc">Their long and pointed pikes are used as the main line of defence in any battle. The Natarian Pikemen are bold and daring warriors who use their dexterity to quickly down enemy horsemen and finish them off.</div>
