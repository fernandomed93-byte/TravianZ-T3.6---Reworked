<h1><img class="unit u27" src="gpack/travian_default/img/x.gif" alt="Ram" title="Ram" /> Ram <span class="tribe">(Gauls)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 1:23:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u27" src="gpack/travian_default/img/x.gif" alt="Ram" title="Ram" /><div id="t_desc">The Ram is a heavy support weapon for your infantry and cavalry. Its task is to destroy the enemy walls and therefore increase your troops’ chances of overcoming the enemy's fortifications.</div>
