<h1><img class="unit u33" src="gpack/travian_default/img/x.gif" alt="Snake" title="Snake" /> Snake <span class="tribe">(Nature)</span></h1>
...
<img id="big_unit" class="big_u33" src="gpack/travian_default/img/x.gif" alt="Snake" title="Snake" /><div id="t_desc">The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Snake will give just 1 experience point.</div>
