<h1><img class="unit u10" src="gpack/travian_default/img/x.gif" alt="Settler" title="Settler" /> Settler <span class="tribe">(Romans)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 7:28:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u10" src="gpack/travian_default/img/x.gif" alt="Settler" title="Settler" /><div id="t_desc">Settlers are brave and daring citizens who move out of the village after a long training session to found a new village in your honour. 
<br /><br />
