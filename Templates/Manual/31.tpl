<h1><img class="unit ugeb" src="gpack/travian_default/img/x.gif" alt="" title="" /> Buildings (Resources)</h1>
<ul>
...
<map id="nav" name="nav">
    <area href="<?php echo NEW_FUNCTIONS_MANUAL_NATURENATARS ? "manual.php?typ=2&amp;s=5" : "manual.php?typ=2&amp;s=9"; ?>" title="back" coords="0,0,45,18" shape="rect" alt="" />
