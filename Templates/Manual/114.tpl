<h1><img class="unit u14" src="gpack/travian_default/img/x.gif" alt="Scout" title="Scout" /> Scout <span class="tribe">(Teutons)</span></h1>
...
<img id="big_unit" class="big_u14" src="gpack/travian_default/img/x.gif" alt="Scout" title="Scout" /><div id="t_desc">The Scout moves far ahead of the Teuton troops in order to get an impression of the enemy's strength and his villages. He moves on foot, which makes him slower than his Roman or Gaul counterparts. He scouts the enemy units, resources and fortifications. 
<br /><br />
