<h1><img class="unit u12" src="gpack/travian_default/img/x.gif" alt="Spearman" title="Spearman" /> Spearman <span class="tribe">(Teutons)</span></h1>
...
<img id="big_unit" class="big_u12" src="gpack/travian_default/img/x.gif" alt="Spearman" title="Spearman" /><div id="t_desc">In the Teuton army the Spearman’s task is defence. He is especially good against cavalry thanks to his weapons length.
<br /><br />
