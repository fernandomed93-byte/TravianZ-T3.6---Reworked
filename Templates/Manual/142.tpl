<h1><img class="unit u42" src="gpack/travian_default/img/x.gif" alt="Thorned Warrior" title="Thorned Warrior" /> Thorned Warrior <span class="tribe">(Natars)</span></h1>
