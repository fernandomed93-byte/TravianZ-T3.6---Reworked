<h1><img class="unit u4" src="gpack/travian_default/img/x.gif" alt="Equites Legati" title="Equites Legati" /> Equites Legati <span class="tribe">(Romans)</span></h1>
...
<img id="big_unit" class="big_u4" src="gpack/travian_default/img/x.gif" alt="Equites Legati" title="Equites Legati" /><div id="t_desc">The Equites Legati are the roman reconnaissance troops. They are pretty fast and can spy on enemy villages in order to see resources and troops.
<br /><br />
