<h1><img class="unit u24" src="gpack/travian_default/img/x.gif" alt="Theutates Thunder" title="Theutates Thunder" /> Theutates Thunder <span class="tribe">(Gauls)</span></h1>
...
<img id="big_unit" class="big_u24" src="gpack/travian_default/img/x.gif" alt="Theutates Thunder" title="Theutates Thunder" /><div id="t_desc">Theutates Thunders are very fast and powerful cavalry units. They can carry a large amount of resources which makes them excellent raiders too.
<br /><br />
