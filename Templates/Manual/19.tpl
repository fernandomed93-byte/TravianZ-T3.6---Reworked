<h1><img class="unit u9" src="gpack/travian_default/img/x.gif" alt="Senator" title="Senator" /> Senator <span class="tribe">(Romans)</span></h1>
...
<img id="big_unit" class="big_u9" src="gpack/travian_default/img/x.gif" alt="Senator" title="Senator" /><div id="t_desc">The Senator is the tribe's chosen leader. He's a good speaker and knows how to convince others. He is able to persuade other villages to fight with the empire. 
<br /><br />
