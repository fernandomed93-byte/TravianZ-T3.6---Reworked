<h1><img class="unit u40" src="gpack/travian_default/img/x.gif" alt="Elephant" title="Elephant" /> Elephant <span class="tribe">(Nature)</span></h1>
...
<tr>
	<th>Upkeep</th>
	<td><img class="r5" src="gpack/travian_default/img/x.gif" alt="Crop consumption" title="Crop consumption" /> 5</td>
</tr>
<tr>
...
<img id="big_unit" class="big_u40" src="gpack/travian_default/img/x.gif" alt="Elephant" title="Elephant" /><div id="t_desc">The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Elephant will give just 5 experience point.</div>
