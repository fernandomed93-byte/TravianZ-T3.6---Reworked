<h1><img class="unit u5" src="gpack/travian_default/img/x.gif" alt="Equites Imperatoris" title="Equites Imperatoris" /> Equites Imperatoris <span class="tribe">(Romans)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:44:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u5" src="gpack/travian_default/img/x.gif" alt="Equites Imperatoris" title="Equites Imperatoris" /><div id="t_desc">The Equites Imperatoris are the standard cavalry of the roman army and are very well armed. They are not the fastest troops, but are a horror for unprepared enemies. You should, however, always keep in mind that catering for horse and rider isn't cheap.</div>
