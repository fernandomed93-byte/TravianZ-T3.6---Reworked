<h1><img class="unit uunits" src="gpack/travian_default/img/x.gif" alt="" title="" /> Troops (Gauls)</h1>
<ul>
...
<map id="nav" name="nav">
    ...
    <area href="<?php echo NEW_FUNCTIONS_MANUAL_NATURENATARS ? "manual.php?typ=2&amp;s=4" : "manual.php?typ=2&amp;s=6"; ?>" title="forward" coords="71,0,116,18" shape="rect" alt="" />
</map>
