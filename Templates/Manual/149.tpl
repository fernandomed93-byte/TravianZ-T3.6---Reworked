<h1><img class="unit u49" src="gpack/travian_default/img/x.gif" alt="Natarian Emperor" title="Natarian Emperor" /> Natarian Emperor <span class="tribe">(Natars)</span></h1>
