<h1><img class="unit u11" src="gpack/travian_default/img/x.gif" alt="Clubswinger" title="Clubswinger" /> Clubswinger <span class="tribe">(Teutons)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:12:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u11" src="gpack/travian_default/img/x.gif" alt="Clubswinger" title="Clubswinger" /><div id="t_desc">Clubswingers are the cheapest unit in Travian. They are quickly trained and have medium attack capabilities but their armour isn’t the best. Clubswingers are almost defenceless against cavalry and will be ridden down with ease.</div>
