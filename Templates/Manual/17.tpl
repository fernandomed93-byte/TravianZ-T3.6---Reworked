<h1><img class="unit u7" src="gpack/travian_default/img/x.gif" alt="Battering Ram" title="Battering Ram" /> Battering Ram <span class="tribe">(Romans)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 1:16:40</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u7" src="gpack/travian_default/img/x.gif" alt="Battering Ram" title="Battering Ram" /><div id="t_desc">The Battering Ram is a heavy support weapon for your infantry and cavalry. Its task is to destroy the enemy walls and therefore increase your troops’ chances of overcoming the enemy's fortifications.</div>
