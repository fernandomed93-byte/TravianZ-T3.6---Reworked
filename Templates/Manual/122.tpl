<h1><img class="unit u22" src="gpack/travian_default/img/x.gif" alt="Swordsman" title="Swordsman" /> Swordsman <span class="tribe">(Gauls)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:24:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u22" src="gpack/travian_default/img/x.gif" alt="Swordsman" title="Swordsman" /><div id="t_desc">The Swordsmen are more expensive than the Phalanx, but they are an attacking unit.
<br /><br />
