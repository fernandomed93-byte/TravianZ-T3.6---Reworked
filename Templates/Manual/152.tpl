<h1><img class="unit u52" src="gpack/travian_default/img/x.gif" alt="Bowman" title="Bowman" /> Bowman <span class="tribe">(Huns)</span></h1>
...
<img id="big_unit" class="big_u52" src="gpack/travian_default/img/x.gif" alt="Bowman" title="Bowman" /><div id="t_desc">The Bowman serves as the Hun ranged infantry. Armed with a composite bow, he can strike enemies from a distance before they reach melee range. His attack power is decent for an infantry unit, though his light armor leaves him vulnerable in close combat.</div>
<div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=19">Barracks</a> Level 3<br /><a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 3 &amp; <a href="manual.php?typ=4&amp;gid=12">Blacksmith</a> Level 1</div>
<map id="nav" name="nav">
