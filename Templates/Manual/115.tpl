<h1><img class="unit u15" src="gpack/travian_default/img/x.gif" alt="Paladin" title="Paladin" /> Paladin <span class="tribe">(Teutons)</span></h1>
...
<img id="big_unit" class="big_u15" src="gpack/travian_default/img/x.gif" alt="Paladin" title="Paladin" /><div id="t_desc">As they are equipped with heavy armour Paladins are a great defensive unit. Infantry will find it especially hard to get through his shield. 
<br /><br />
