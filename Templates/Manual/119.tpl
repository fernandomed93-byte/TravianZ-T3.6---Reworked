<h1><img class="unit u19" src="gpack/travian_default/img/x.gif" alt="Chief" title="Chief" /> Chief <span class="tribe">(Teutons)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 19:35:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u19" src="gpack/travian_default/img/x.gif" alt="Chief" title="Chief" /><div id="t_desc">Out of their midst the Teutons choose their Chief. To be chosen, bravery and strategy aren't enough; you also have to be a formidable speaker as it is the Chief's primary objective to convince the population of foreign villages to join the Chief's tribe. 
<br /><br />
