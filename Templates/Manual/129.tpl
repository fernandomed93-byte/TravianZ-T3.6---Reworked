<h1><img class="unit u29" src="gpack/travian_default/img/x.gif" alt="Chieftain" title="Chieftain" /> Chieftain <span class="tribe">(Gauls)</span></h1>
...
<img id="big_unit" class="big_u29" src="gpack/travian_default/img/x.gif" alt="Chieftain" title="Chieftain" /><div id="t_desc">Each tribe has an ancient and experienced fighter whose presence and speeches are able to convince the population of enemy villages to join his tribe.
<br /><br />
