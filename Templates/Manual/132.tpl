<h1><img class="unit u32" src="gpack/travian_default/img/x.gif" alt="Spider" title="Spider" /> Spider <span class="tribe">(Nature)</span></h1>
...
<img id="big_unit" class="big_u32" src="gpack/travian_default/img/x.gif" alt="Spider" title="Spider" /><div id="t_desc">The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Spider will give just 1 experience point.</div>
