<h1><img class="unit u54" src="gpack/travian_default/img/x.gif" alt="Steppe Rider" title="Steppe Rider" /> Steppe Rider <span class="tribe">(Huns)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:40:00</td>
</tr></tbody>
</table>
<img id="big_unit" class="big_u54" src="gpack/travian_default/img/x.gif" alt="Steppe Rider" title="Steppe Rider" /><div id="t_desc">The Steppe Rider is a light cavalryman born and raised on the vast plains. His speed and mobility make him an excellent raider, capable of striking enemy resource shipments and isolated villages. While lightly armored, his charge packs a considerable punch.</div>
