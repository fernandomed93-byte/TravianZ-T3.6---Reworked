<h1><img class="unit u43" src="gpack/travian_default/img/x.gif" alt="Guardsman" title="Guardsman" /> Guardsman <span class="tribe">(Natars)</span></h1>
...
<img id="big_unit" class="big_u43" src="gpack/travian_default/img/x.gif" alt="Guardsman" title="Guardsman" /><div id="t_desc">Adored by their people and feared by their enemies, a Guardsman fights without a mount but is nevertheless one of the most valuable soldiers in the Natarian army, thanks to his versatility. They are deemed as well trained fighters, leaving their enemies with almost no chances to win. Due to their heavy armour, they can be used as strong and reliable defence troops too.</div>
