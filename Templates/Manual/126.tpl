<h1><img class="unit u26" src="gpack/travian_default/img/x.gif" alt="Haeduan" title="Haeduan" /> Haeduan <span class="tribe">(Gauls)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:52:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u26" src="gpack/travian_default/img/x.gif" alt="Haeduan" title="Haeduan" /><div id="t_desc">The Haeduans are the Gaul's ultimate weapon for attacking and defending against cavalry. Few can match them in these points.
<br /><br />
