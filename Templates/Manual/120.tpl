<h1><img class="unit u20" src="gpack/travian_default/img/x.gif" alt="Settler" title="Settler" /> Settler <span class="tribe">(Teutons)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 8:36:40</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u20" src="gpack/travian_default/img/x.gif" alt="Settler" title="Settler" /><div id="t_desc">Settlers are brave and daring citizens who move out of the village after a long training session to found a new village in your honour. 
<br /><br />
