<h1><img class="unit u16" src="gpack/travian_default/img/x.gif" alt="Teutonic Knight" title="Teutonic Knight" /> Teutonic Knight <span class="tribe">(Teutons)</span></h1>
...
<tr>
	...
	<td><img class="clock" src="gpack/travian_default/img/x.gif" alt="duration" title="duration" /> 0:49:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u16" src="gpack/travian_default/img/x.gif" alt="Teutonic Knight" title="Teutonic Knight" /><div id="t_desc">The Teutonic Knight is a formidable warrior and brings fear and despair over his foes. In defence he stands out against enemy cavalry. However, the cost of training and feeding him is extraordinary.</div>
