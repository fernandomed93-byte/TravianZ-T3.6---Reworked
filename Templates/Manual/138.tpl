<h1><img class="unit u38" src="gpack/travian_default/img/x.gif" alt="Crocodile" title="Crocodile" /> Crocodile <span class="tribe">(Nature)</span></h1>
...
<img id="big_unit" class="big_u38" src="gpack/travian_default/img/x.gif" alt="Crocodile" title="Crocodile" /><div id="t_desc">The experience a hero gains by killing an animal is determined by the upkeep the animal needed. This means a Crocodile will give just 3 experience point.</div>
