...
if($aantal > 0){
	...
	echo '<tr><td class="typ"><a href="build.php?id=39"><img src="gpack/travian_default/img/x.gif" class="'.$action.'" alt="'.$title.'" title="'.$title.'" /></a><span class="'.$aclass.'">&raquo;</span></td>
