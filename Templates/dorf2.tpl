...
for($i = 1; $i <= 20; $i++){
	if($village->natar == 1 and (($i + 18) == '25' || ($i + 18) == '26' || ($i + 18) == '29' || ($i + 18) == '30' || ($i + 18) == '33')){
		...
		echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"building d$i $img\" alt=\"$text\" />";
		// set event last quest
		if(($_SESSION['qst'] == 38 && QTYPE == 37) || ($_SESSION['qst'] == 31 && QTYPE == 25)){
			if($i < 8){
				$dte = ["tur", "purp", "yell", "oran", "green", "red", "dark"];
				$im = $dte[$i - 1];
				echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"building e$i rocket $im\" alt=\"$text\" />";
			}
		}
	}
}
...
if($village->resarray['f39'] == 0){
	if($building->rallying()) echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"dx1 g16b\" alt=\"Rally Point Level ".$village->resarray['f39']."\" />";
	else echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"dx1 g16e\" alt=\"Rally Point building site\" />";
}
else echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"dx1 g16\" alt=\"Rally Point Level ".$village->resarray['f39']."\" />";
	
?>
<?php
if($village->resarray['f99t'] == 40){
	if($village->resarray['f99'] >= 0 && $village->resarray['f99'] <= 19){
		echo '<img class="ww g40" src="gpack/travian_default/img/x.gif" alt="Worldwonder">';
	}
	if($village->resarray['f99'] >= 20 && $village->resarray['f99'] <= 39){
		echo '<img class="ww g40_1" src="gpack/travian_default/img/x.gif" alt="Worldwonder">';
	}
	if($village->resarray['f99'] >= 40 && $village->resarray['f99'] <= 59){
		echo '<img class="ww g40_2" src="gpack/travian_default/img/x.gif" alt="Worldwonder">';
	}
	if($village->resarray['f99'] >= 60 && $village->resarray['f99'] <= 79){
		echo '<img class="ww g40_3" src="gpack/travian_default/img/x.gif" alt="Worldwonder">';
	}
	if($village->resarray['f99'] >= 80 && $village->resarray['f99'] <= 99){
		echo '<img class="ww g40_4" src="gpack/travian_default/img/x.gif" alt="Worldwonder">';
	}
	if($village->resarray['f99'] == 100){
		echo '<img class="ww g40_5" src="gpack/travian_default/img/x.gif" alt="Worldwonder">';
	}
}
?>
    <div id="levels"
...
?>
	...
	<img class="map1" usemap="#map1" src="gpack/travian_default/img/x.gif" alt="" /> <img
		class="map2" usemap="#map2" src="gpack/travian_default/img/x.gif" alt="" />
</div>
<img src="gpack/travian_default/img/x.gif" id="lswitch"
	<?php if(isset($_COOKIE['t3l'])) { echo "class=\"on\""; } ?>
