...
<div align="center">
	<table border="1" width="50%" cellspacing="0" cellpadding="0">
		<tr>
			<td align="center" width="25%"><img class="r1" src="gpack/travian_default/img/x.gif" alt="Lumber" title="Lumber" />Lumber</td>
			<td align="center" width="25%"><img class="r2" src="gpack/travian_default/img/x.gif" alt="Clay" title="Clay" />Clay</td>
			<td align="center" width="25%"><img class="r3" src="gpack/travian_default/img/x.gif" alt="Iron" title="Iron" />Iron</td>
			<td align="center" width="25%"><img class="r4" src="gpack/travian_default/img/x.gif" alt="Crop" title="Crop" />Crop</td>
		</tr>
		<tr>
			<td align="center">
<?php
