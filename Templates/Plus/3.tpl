	...
	<tbody>
		...
		<tr>
			<td class="man"><a href="#" onClick="return Popup(0,6);"><img
					class="help" src="gpack/travian_default/img/x.gif" alt="" title="" /></a></td>
...
if (PLUS_TIME >= 86400) {
    ...
    ?>
			...
			<td class="cost"><img src="gpack/travian_default/img/x.gif" class="gold" alt="Gold"
...
?>
		...
		<tr>
			<td class="man"><a href="#" onClick="return Popup(1,6);"><img
					class="help" src="gpack/travian_default/img/x.gif" alt="" title="" /></a></td>
			<td class="desc">+<b>25</b>% <img class="r1" src="gpack/travian_default/img/x.gif"
...
?>
		...
		<tr>
			...
			<td class="desc">+<b>25</b>% <img class="r2" src="gpack/travian_default/img/x.gif"
...
?>
		...
		<tr>
			<td class="man"><a href="#" onClick="return Popup(3,6);"><img
					class="help" src="gpack/travian_default/img/x.gif" alt="" title="" /></a></td>
			<td class="desc">+<b>25</b>% <img class="r3" src="gpack/travian_default/img/x.gif"
...
&nbsp;    </span></a></td>
		...
		<tr>
			...
			<td class="man"><a href="#" onClick="return Popup(4,6);"><img
					class="help" src="gpack/travian_default/img/x.gif" alt="" title="" /></a></td>
			<td class="desc">+<b>25</b>% <img class="r4" src="gpack/travian_default/img/x.gif"
...
if ($session->access != BANNED) {
    if (mysqli_num_rows($MyGold)) {
        if ($golds['gold'] > 1 && $village->natar!=1) {
            echo '
                <a href="plus.php?id=7"><span>On';
        } else if ($village->natar==1){
            echo "Can't use in this village";
        } else {
            echo '<a href="plus.php?s=1"><span class="none">too little gold';
        }
    }
...
if ($session->access != BANNED) {
    if (mysqli_num_rows($MyGold)) {
        if ($golds['gold'] > 2 && $village->natar!=1) {
