...
?>
<img src="gpack/travian_default/img/x.gif" id="detailed_map" class="f99" alt="<?php echo PLANVILLAGE;?>" />
<?php }else{ ?>
<img src="gpack/travian_default/img/x.gif" id="detailed_map" class="<?php echo ($basearray['fieldtype'] == 0)? 'w'.$basearray['oasistype'] : 'f'.$basearray['fieldtype'] ?>" alt="<?php 
...
$ttt = "<td class=\"ico\"><img class=\"r1\" src=\"gpack/travian_default/img/x.gif\" title=\"".LUMBER."\"> 25% ".LUMBER."</td>";
break;
case 3:
$tt =  "+25% ".LUMBER." and +25% ".CROP." ".PERHOUR."\" title=\"+25% ".LUMBER." and +25% ".CROP." ".PERHOUR;
$ttt = "<td class=\"ico\"><img class=\"r1\" src=\"gpack/travian_default/img/x.gif\" title=\"".LUMBER."\"> 25% ".LUMBER."</td>
		<tr><td class=\"ico\"><img class=\"r4\" src=\"gpack/travian_default/img/x.gif\" title=\"".CROP."\"> 25% ".CROP."</td></tr>";
break;
case 4:
case 5:
$tt =  "+25% ".CLAY." ".PERHOUR."\" title=\"+25% ".CLAY." ".PERHOUR;
$ttt = "<td class=\"ico\"><img class=\"r2\" src=\"gpack/travian_default/img/x.gif\" title=\"".CLAY."\"> 25% ".CLAY."</td>";
break;
case 6:
...
$ttt = "<td class=\"ico\"><img class=\"r3\" src=\"gpack/travian_default/img/x.gif\" title=\"".IRON."\"> 25% ".IRON."</td>";
break;
case 9:
...
$ttt = "<td class=\"ico\"><img class=\"r4\" src=\"gpack/travian_default/img/x.gif\" title=\"".CROP."\"> 25% ".CROP."</td>";
break;
case 12:
$tt =  "+50% ".CROP." ".PERHOUR."\" title=\"+50% ".CROP." ".PERHOUR;
$ttt = "<td class=\"ico\"><img class=\"r4\" src=\"gpack/travian_default/img/x.gif\" title=\"".CROP."\"> 50% ".CROP."</td>";
break;
}
break;
}
...
<table cellpadding="1" cellspacing="1" id="troop_info" class="tableNone">
        ...
        for ($i = 31; $i <= 40; $i++) {
        	if($unit['u'.$i] > 0){
        		...
        		echo '<tr>';
        		echo '<td class="ico"><img class="unit u'.$i.'" src="gpack/travian_default/img/x.gif" alt="'.$unarray[$i].'" title="'.$unarray[$i].'" /></td>';
...
<table cellpadding="1" cellspacing="1" id="troop_info" class="tableNone rep">
		...
		if ($basearray['oasistype'] > 0){
			$vilData = $database->getOasisV($_GET['d']);
		}else{
...
if($type >= 18 && $type <= 21){
    ...
    echo "<img src=\"gpack/travian_default/img/x.gif\" class=\"iReport iReport".$row['ntype']."\" title=\"".$topic."\"> ";
	}
...
<table cellpadding="1" cellspacing="1" id="troop_info" class="tableNone rep">
		...
		$thisVilOwner = null;
		if ($basearray['oasistype'] > 0){
			$thisVilOwner = $database->getOasisV($_GET['d'])['owner'];
		}else{
			$thisVilOwner = $database->getVillage($_GET['d'])['owner'];
		}
		
		
if($session->uid == $thisVilOwner){
...
?>
	<table cellpadding="1" cellspacing="1" id="distribution" class="tableNone">
		...
		<tbody>
						<tr>
				<td class="ico"><img class="r1" src="gpack/travian_default/img/x.gif" alt="<?php echo LUMBER;?>" title="<?php echo LUMBER;?>" /></td>
				<td class="val"><?php echo $landd['0']; ?></td>
				<td class="desc"><?php echo WOODCUTTER;?></td>

			</tr>
						<tr>
				<td class="ico"><img class="r2" src="gpack/travian_default/img/x.gif" alt="<?php echo CLAY;?>" title="<?php echo CLAY;?>" /></td>
				<td class="val"><?php echo $landd['1']; ?></td>
				<td class="desc"><?php echo CLAYPIT;?></td>
			</tr>
						<tr>
				<td class="ico"><img class="r3" src="gpack/travian_default/img/x.gif" alt="<?php echo IRON;?>" title="<?php echo IRON;?>" /></td>

				<td class="val"><?php echo $landd['2']; ?></td>
				<td class="desc"><?php echo IRONMINE;?></td>
			</tr>
						<tr>
				<td class="ico"><img class="r4" src="gpack/travian_default/img/x.gif" alt="<?php echo CROP;?>" title="<?php echo CROP;?>" /></td>
