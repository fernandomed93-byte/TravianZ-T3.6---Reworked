...
<div id="map_content">
	<div id="mbig">
		<div id="lightframe">
			<div id="darkframe"><a id="map_popclose" onClick="pb=document.getElementById('drag2');if(pb!=null){pb.innerHTML='';};return false;"><img src="gpack/travian_default/img/x.gif" alt="Close Map" title="Close Map"></a>
				...
				<div id="map">
					...
					<map id="map_overlay_large" name="map_overlay_large"> 
						<?php echo $map_gen;?>
						<area id="ma_n1" href="karte2.php?z=<?php echo $generator->getBaseIDMAP($x,$yp1);?>" coords="762,115,30" shape="circle" title="North"/>
						<area id="ma_n2" href="karte2.php?z=<?php echo $generator->getBaseIDMAP($xp1,$y);?>" coords="770,430,30" shape="circle" title="East"/>
						<area id="ma_n3" href="karte2.php?z=<?php echo $generator->getBaseIDMAP($x,$ym1);?>" coords="210,430,30" shape="circle" title="South"/>
						<area id="ma_n4" href="karte2.php?z=<?php echo $generator->getBaseIDMAP($xm1,$y);?>" coords="200,115,30" shape="circle" title="West"/>
					</map>
					<img id="map_links" src="gpack/travian_default/img/x.gif" usemap="#map_overlay_large">
					<script type="text/javascript">
						m_c.az = {"n1":<?php echo $generator->getBaseIDMAP($x,$yp1) ?>,"n1p7":<?php echo $generator->getBaseIDMAP($x,$yp7) ?>,"n2":<?php echo $generator->getBaseIDMAP($xp1,$y) ?>,"n2p7":<?php echo $generator->getBaseIDMAP($xm7,$y) ?>,"n3":<?php echo $generator->getBaseIDMAP($x,$ym1) ?>,"n3p7":<?php echo $generator->getBaseIDMAP($x,$ym7) ?>,"n4":<?php echo $generator->getBaseIDMAP($xm1,$y) ?>,"n4p7":<?php echo $generator->getBaseIDMAP($xp7,$y) ?>};
					...
					<map name="map_navibox">
						<area id="ma_n1p7" href="karte.php?z=<?php echo $generator->getBaseIDMAP($x,$yp7) ?>" coords="51,15,73,3,95,15,73,27" shape="poly" title="North"/>
						<area id="ma_n2p7" href="karte.php?z=<?php echo $generator->getBaseIDMAP($xm7,$y) ?>" coords="51,41,73,29,95,41,73,53" shape="poly" title="East"/>
						<area id="ma_n3p7" href="karte.php?z=<?php echo $generator->getBaseIDMAP($x,$ym7) ?>" coords="4,41,26,29,48,41,26,53" shape="poly" title="South"/>
						<area id="ma_n4p7" href="karte.php?z=<?php echo $generator->getBaseIDMAP($xp7,$y) ?>" coords="4,15,26,3,48,15,26,27" shape="poly" title="West"/>
					</map>
					<div id="map_coords">
						<form name="map_coords" method="post" >
							...
							<input type="image" id="btn_ok" class="dynamic_img" value="ok" name="s1" src="gpack/travian_default/img/x.gif" alt="OK" />
						</form>
					</div>
