...
<body class="webkit chrome">
	...
	<div id="background">
		<div id="content-container">
			<img alt="Logo" id="logoMed" src="gpack/travian_default/img/x.gif" />
			<div id="header">
				<img src="gpack/travian_default/img/x.gif" id="brand" alt="Travian"/> <?php echo $lang['notification']['awaits_you']; ?></div>
			...
			<div id="senden-container">
				...
				<img id="featureLookHead" src="gpack/travian_default/img/x.gif" alt="<?php echo $lang['notification']['screenshots']; ?>" />
