...
if(isset($_GET['del_cookie'])) {
	setcookie("COOKUSR_T3","",time()-3600*24,COOKIE_PATH);
	setcookie("COOKEMAIL","",time()-3600*24,COOKIE_PATH);
	header("Location: login.php");
	exit;
}
if(!isset($_COOKIE['COOKUSR_T3'])) {
	$_COOKIE['COOKUSR_T3'] = "";
}
...
<h1><img class="img_login" src="gpack/travian_default/img/x.gif" alt="log in the game" /></h1>
...
{
?>
<h5><img class="img_u04" src="gpack/travian_default/img/x.gif" alt="login" /></h5>
...
<table cellpadding="1" cellspacing="1" id="login_form">
	<tbody>
		<tr class="top">
			<th><?php echo NAME; ?></th>
			<td><input class="text" type="text" name="user" value="<?php echo htmlspecialchars($form->getDiff("user",$_COOKIE['COOKUSR_T3'])); ?>" maxlength="30" autocomplete='off' /> <span class="error"> <?php echo $form->getError("user"); ?></span></td>
		</tr>
		<tr class="btm">
