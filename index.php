...
<body class="presto indexPage">
	<div class="wrapper">
		...
		<div id="navigation">
			<a href="index.php" class="home"><img src="gpack/travian_default/img/x.gif" alt="Travian" /></a>
			<table class="menu">
				<tr>
			...
			<div class="grit">
				...
				<div class="secondarybox">
					<div id="screenshots">
						...
						<a href="#last" class="navi prev dynamic_btn"><img class="dynamic_btn" src="gpack/travian_default/img/x.gif" alt="previous" /></a>
						...
						</div><a href="#next" class="navi next"><img class="dynamic_btn" src="gpack/travian_default/img/x.gif" alt="next" /></a>
					</div>
					<div id="newsbox">
						<h2><?php echo NEWS; ?></h2>
	...
	<div id="screenshot_layer" class="overlay">
		...
		<div class="overlay_content">
			...
			<a href="#" class="closer"><img class="dynamic_img" alt="Close" src="gpack/travian_default/img/x.gif" /></a>
			<div class="screenshot_view">
				<h4 id="screen_hl"></h4>
				<img id="screen_view" src="gpack/travian_default/img/x.gif" alt="Screenshot" name="screen_view" />
				<div id="screen_desc"></div>
			</div>
			<a href="#prev" class="navi prev" onclick="galarie.showPrev();"><img class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="previous" /></a>
			<a href="#next" class="navi next" onclick="galarie.showNext();"><img class="dynamic_img" src="gpack/travian_default/img/x.gif" alt="next" /></a>
			<div class="footer"></div>
		</div>
	</div>
	<script type="text/javascript">
