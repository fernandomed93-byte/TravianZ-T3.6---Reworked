...
<form action="process.php" method="post" id="dataform">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <select name="tzone" onChange="refresh(this.value)">
                    ...
                    <option value="2,America/New_York" <?php if ($tz==2) echo "selected";?>>New York</option>
					...
					<option value="13,America/Sao_Paulo" <?php if ($tz==13) echo "selected";?>>Sao Paulo</option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="140"><input type="text" name="natars_units" id="natars_units" value="4" size="3"></td>         
        </tr>
        <tr>
        	<td><span class="f9 c6">Natars Spawn (Days):</span></td>
            <td width="140"><input type="text" name="natars_spawn_time" id="natars_spawn_time" value="90" size="3"></td>
        </tr>
        <tr>
        	<td><span class="f9 c6">WW spawn (Days):</span></td>
            <td width="140"><input type="text" name="natars_ww_spawn_time" id="natars_ww_spawn_time" value="120" size="3"></td>
        </tr>
        <tr>
        	<td><span class="f9 c6">WW building plan spawn (Days):</span></td>
            <td width="140"><input type="text" name="natars_ww_building_plan_spawn_time" id="natars_ww_building_plan_spawn_time" value="180" size="3"></td>           
        </tr>      
        <tr>
