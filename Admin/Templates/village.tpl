...
if(isset($id)){
	...
	if($village && $user){
		...
		<table id="member">
			...
			<tbody>
				<tr>
					<td><img class="r1" src="../gpack/travian_default/img/x.gif"> Lumber</td>
			...
			<div id="village_map" class="f<?php echo $database->getVillageType($village['wref']); ?>" style="float: left;">
				<?php
					for($f = 1; $f < 19; $f++){
						$gid = $fdata['f'.($f).'t'];
						$level = $fdata['f'.($f)];
						echo "<img src=\"../gpack/travian_default/img/x.gif\" class=\"reslevel rf".$f." level".$level."\">";
					}
	...
	<div id="content" class="village2" style="padding: 0; margin-left: -20px;">
		...
		<div id="village_map" class="<?php echo $wallType; ?>">
			...
			for($b = 1; $b < 21; $b++){
				$gid = $fdata['f'.($b + 18).'t'];
				if($gid > 0) echo "<img src=\"../gpack/travian_default/img/x.gif\" class=\"building d".$b." g".$gid."\">";
				elseif($gid == 0) echo "<img src=\"../gpack/travian_default/img/x.gif\" class=\"building d".$b." iso\">";
			}
			
			$rplevel = $fdata['f39t'];
			
			if($rplevel > 0) echo "<img src=\"../gpack/travian_default/img/x.gif\" class=\"dx1 g16\">";
			elseif($rplevel == 0) echo "<img src=\"../gpack/travian_default/img/x.gif\" class=\"dx1 g16e\">";
