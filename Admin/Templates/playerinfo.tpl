				...
				<tr>
					<td class="details">
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								<th>Population</th>
								<td><?php echo $totalpop;?> <a href="?action=recountPopUsr&uid=<?php echo $user['id'];?>"><?php echo $refreshicon; ?></a> <a href="?action=recountPopAll"><?php echo $refreshicon; ?></a></td>
							</tr>
							<tr>
								<th>Age</td>
								<td>
							...
							<?php
								...
								if($_SESSION['access'] == ADMIN)
								{
									...
									<tr>
										<td colspan="2">
											<a class="rn3" href="?action=DellDeletingPlayers"><font color="red">&raquo;</font> Delete All</a>
										</td>
									</tr>';
								}
								else if($_SESSION['access'] == MULTIHUNTER)
