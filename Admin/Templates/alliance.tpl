			...
			<?php
				...
				foreach($aliusers as $user)
				{
					...
					if($aid == $session->alliance)
					{
						...
						{
							// 10 Min - 1 Days
							echo "<td class=on><img class=online2 src=gpack/travian_default/img/x.gif title=now online alt=now online /></td>";
						}
						elseif ((time()-259200) < $user['timestamp'] && (time()-86400) > $user['timestamp'])
						{
							// 1-3 Days
							echo "<td class=on><img class=online3 src=gpack/travian_default/img/x.gif title=now online alt=now online /></td>";
						}
						elseif ((time()-604800) < $user['timestamp'] && (time()-259200) > $user['timestamp'])
						{
							echo "<td class=on><img class=online4 src=gpack/travian_default/img/x.gif title=now online alt=now online /></td>";
						}
						else
						{
							echo "<td class=on><img class=online5 src=gpack/travian_default/img/x.gif title=now online alt=now online /></td>";
						}
					}
					echo "	</tr>";
				}
