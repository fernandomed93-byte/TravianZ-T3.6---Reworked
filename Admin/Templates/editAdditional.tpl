	...
	<form action="../GameEngine/Admin/Mods/additional.php" method="POST">
		...
		<input type="hidden" name="id" value="<?php echo $id; ?>" />
			...
			<table id="profile" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2">
						<input style="float: right" name="save" type="image" id="btn_save" class="dynamic_img" src="gpack/travian_default/img/x.gif" value="save" alt="save" />
						<input style="float: left" name="back" type="image" id="btn_back" class="dynamic_img" src="gpack/travian_default/img/x.gif" value="back" alt="back" onclick="return go_url('../Admin/admin.php?p=player&uid=<?php echo $_GET["uid"];?>')" />
					</td>
				</tr>
				</thead>				
			</table>
