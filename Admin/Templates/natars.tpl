...
<table id="member">
  <thead>
	...
	<tr>
		<td class="icon"><img id="artifactImage" class="artefact_icon_1" src="../gpack/travian_default/img/x.gif"></td>
		<td>
...
<table id="member">
	...
	?>
		<tr>
			...
			<td class="icon"><img class="artefact_icon_<?php echo $artifact['type']; ?>" src="../gpack/travian_default/img/x.gif"></td>
