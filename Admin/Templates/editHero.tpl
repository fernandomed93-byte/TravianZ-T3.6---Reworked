...
function check_unit(el) {
	...
	"<span><img class=\"unit u"+obj.value+"\" src=\"gpack/travian_default/img/x.gif\" alt=\""+uname+"\" title=\""+uname+"\" /></span>";
}
</script>
...
<table style="border-collapse:collapse; margin-top:25px; line-height:16px; width:100%;">
	...
	<tr>
		<td>Hero Unit</td> 
		<td colspan="2"><?php echo "<img class=\"unit u".$hero['unit']."\" src=\"gpack/travian_default/img/x.gif\" alt=\"".$technology->getUnitName($hero['unit'])."\" title=\"".$technology->getUnitName($hero['unit'])."\" /> (".$technology->getUnitName($hero['unit']); ?>)</td>
		<td width="10%" align="center" style="border-right:none"><div id="unt"><?php echo "<img class=\"unit u".$hero['unit']."\" src=\"gpack/travian_default/img/x.gif\" alt=\"".$technology->getUnitName($hero['unit'])."\" title=\"".$technology->getUnitName($hero['unit'])."\" />";?></div></td>
	...
	<tr> 
		...
		<tr class="thead">
			<td style="border-right:none" align="left"><input name="back" type="image" id="btn_back" class="dynamic_img" src="gpack/travian_default/img/x.gif" value="back" alt="back" onclick="return go_url('../Admin/admin.php?p=player&uid=<?php echo $_GET["uid"];?>')" /></td>
			<td style="border-left:none" colspan="5" align="right"><input name="save" type="image" id="btn_save" class="dynamic_img" src="gpack/travian_default/img/x.gif" value="save" alt="save" /></td>
		</tr>
	</table>
	</form>
	<?php
