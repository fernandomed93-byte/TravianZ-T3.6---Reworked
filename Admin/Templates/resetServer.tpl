...
<table id="member">
    ...
    <thead>
        <tr id="hideobj">
            <td style="border-right:none; text-align:left"><input name="back" type="button" src="gpack/travian_default/img/x.gif" value="<< back" alt="back" onclick="go_url('../Admin/admin.php')" /></td>
            <td style="border-left:none; text-align:right"><input name="reset" type="button" src="gpack/travian_default/img/x.gif" value="Reset" alt="Reset" onclick="go_proceed()" /></td>
        </tr>
    </thead>    
</table>
</form>
