...
<div id="content"  class="activate">
		...
		<h1><img src="gpack/travian_default/img/x.gif" class="passwort" alt="new password" /></h1>
		<h5><img src="gpack/travian_default/img/x.gif" class="img_u22" alt="forgotten password" /></h5>
