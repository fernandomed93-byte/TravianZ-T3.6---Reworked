...
## Top 3 Population
	...
	WHERE " . TB_PREFIX . "users.access < ".(INCLUDE_ADMIN ? "10" : "8")." AND (" . TB_PREFIX . "users.tribe <= 3 OR " . TB_PREFIX . "users.tribe > 5)
		...
		<div class="wrapper">
			...
			<div id="mid">
				...
				<div id="content" class="village2" style="font-size: 9pt;">
					...
					nameless worker laid the final stone in what will forever known as the greatest and most magnificent creation in all of history since the fall of the Natars<br /><br />
